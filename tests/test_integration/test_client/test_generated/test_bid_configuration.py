...
class TestBidConfiguration:
    ...
    def test_bid_configuration_upsert_retrieve_default(
        ...
        retrieved_bid_config = power_ops_client.powermodel.day_ahead_configuration.bid_configuration_day_ahead.retrieve(
    ...
    def test_bid_configuration_graphql(
        ...
        response = power_ops_client.powermodel.day_ahead_configuration.graphql_query(query)
