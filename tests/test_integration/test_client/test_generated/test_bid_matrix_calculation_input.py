...
def new_multi_scenario_partial(
    ...
    power_ops_client.powerops.upsert(multi_scenario_partial)
    yield (
        power_ops_client.powerops.shop_based_day_ahead_bid_process.multi_scenario_partial_bid_matrix_calculation_input.retrieve(
            external_id=external_id
        )
    )
...
def new_water_value_based(
    ...
    power_ops_client.powerops.upsert(multi_scenario_partial)
    yield (
        power_ops_client.powerops.water_value_based_day_ahead_bid_process.water_value_based_partial_bid_matrix_calculation_input.retrieve(
            external_id=external_id
        )
    )
    # Clean up after the test
...
class TestBidMatrixCalculationInput:
    def test_shop_graphql(
        ...
        response = power_ops_client.powerops.shop_based_day_ahead_bid_process.graphql_query(query)
    ...
    def test_water_graphql(
        ...
        response = power_ops_client.powerops.water_value_based_day_ahead_bid_process.graphql_query(query)
