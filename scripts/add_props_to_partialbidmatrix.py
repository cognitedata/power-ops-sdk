...
def update_partial_bid_matrix_information(
    ...
    """
    the_partial_bidmatrix = power_client.powermodel.day_ahead_bid.partial_bid_matrix_information.retrieve(external_id=ex_id)
    ...
    power_client.powermodel.upsert(the_partial_bidmatrix_write, replace=False)
...
def update_bid_matrix_information(power_client: PowerOpsClient, ex_id: str):
    ...
    """
    the_bidmatrixinfo = power_client.powermodel.day_ahead_bid.bid_matrix_information.retrieve(external_id=ex_id)
    ...
    power_client.powermodel.upsert(the_bidmatrixinfo_write, replace=False)
...
# lund_partial_bidmatrix = power_client.powermodel.day_ahead_bid.partial_bid_matrix_information.retrieve(external_id=ex_id)
...
# power_client.powermodel.upsert(lund_partial_bidmatrix, replace=False)


# lund_bidmatrixinfo = power_client.powermodel.day_ahead_bid.bid_matrix_information.retrieve(external_id=ex_id)
# lund_bidmatrixinfo = lund_bidmatrixinfo.as_write()
# power_client.powermodel.upsert(lund_bidmatrixinfo, replace=False)
