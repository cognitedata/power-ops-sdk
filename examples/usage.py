def main():
    ...
    # ? Fix me: This usage example is outdated post-refactor (in v.0.25.0)
    # ? A full re-implementation of the usage example is needed should be in docs/notebooks/

    # powerops: PowerOpsClient = get_powerops_client()

    # fornebu = powerops.production.watercourses.retrieve("Fornebu")
    # print(fornebu.)
