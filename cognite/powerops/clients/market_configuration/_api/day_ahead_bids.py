...
from cognite.powerops.clients.market_configuration.data_classes import DayAheadBid, DayAheadBidApply, DayAheadBidList
...
class DayAheadBidsAPI(TypeAPI[DayAheadBid, DayAheadBidApply, DayAheadBidList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "DayAheadBid", "a0e0f04a8176a5"),
