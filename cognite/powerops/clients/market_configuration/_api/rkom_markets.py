...
from cognite.powerops.clients.market_configuration.data_classes import RKOMMarket, RKOMMarketApply, RKOMMarketList
...
class RKOMMarketsAPI(TypeAPI[RKOMMarket, RKOMMarketApply, RKOMMarketList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "RKOMMarket", "1cd6d66e5807a9"),
