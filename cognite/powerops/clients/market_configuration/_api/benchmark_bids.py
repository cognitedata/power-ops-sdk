...
from cognite.powerops.clients.market_configuration.data_classes import BenchmarkBid, BenchmarkBidApply, BenchmarkBidList
...
class BenchmarkBidsAPI(TypeAPI[BenchmarkBid, BenchmarkBidApply, BenchmarkBidList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "BenchmarkBid", "1f8e11dbf4f1dd"),
