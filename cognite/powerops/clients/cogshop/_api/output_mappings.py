...
from cognite.powerops.clients.cogshop.data_classes import OutputMapping, OutputMappingApply, OutputMappingList
...
class OutputMappingsAPI(TypeAPI[OutputMapping, OutputMappingApply, OutputMappingList]):
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> OutputMappingList:
