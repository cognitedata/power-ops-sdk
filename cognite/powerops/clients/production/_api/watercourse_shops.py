...
from cognite.powerops.clients.production.data_classes import WatercourseShop, WatercourseShopApply, WatercourseShopList
...
class WatercourseShopsAPI(TypeAPI[WatercourseShop, WatercourseShopApply, WatercourseShopList]):
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> WatercourseShopList:
