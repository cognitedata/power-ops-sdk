...
if TYPE_CHECKING:
    from cognite.powerops.clients.data_classes._processing_logs import ProcessingLogApply
    from cognite.powerops.clients.data_classes._scenarios import ScenarioApply
