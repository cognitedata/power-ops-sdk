...
from cognite.powerops.clients.core.data_classes import PriceArea, PriceAreaApply, PriceAreaList
...
class PriceAreasAPI(TypeAPI[PriceArea, PriceAreaApply, PriceAreaList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "PriceArea", "e5087dfac16576"),
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> PriceAreaList:
