...
from cognite.powerops.clients.core.data_classes import Watercourse, WatercourseApply, WatercourseList
...
class WatercoursesAPI(TypeAPI[Watercourse, WatercourseApply, WatercourseList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "Watercourse", "babcecafa38fbe"),
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> WatercourseList:
