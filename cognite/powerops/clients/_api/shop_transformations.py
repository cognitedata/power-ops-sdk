...
from cognite.powerops.clients.data_classes import ShopTransformation, ShopTransformationApply, ShopTransformationList
...
class ShopTransformationsAPI(TypeAPI[ShopTransformation, ShopTransformationApply, ShopTransformationList]):
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> ShopTransformationList:
