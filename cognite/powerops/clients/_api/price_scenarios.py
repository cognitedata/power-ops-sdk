...
from cognite.powerops.clients.data_classes import PriceScenario, PriceScenarioApply, PriceScenarioList
...
class PriceScenariosAPI(TypeAPI[PriceScenario, PriceScenarioApply, PriceScenarioList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "PriceScenario", "f37d09fbd48d26"),
