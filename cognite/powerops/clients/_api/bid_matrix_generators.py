...
from cognite.powerops.clients.data_classes import BidMatrixGenerator, BidMatrixGeneratorApply, BidMatrixGeneratorList
...
class BidMatrixGeneratorsAPI(TypeAPI[BidMatrixGenerator, BidMatrixGeneratorApply, BidMatrixGeneratorList]):
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> BidMatrixGeneratorList:
