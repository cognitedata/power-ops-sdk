...
from cognite.powerops.clients.market import MarketClient
from cognite.powerops.clients.production import ProductionClient
...
class PowerOpsClient:
    def __init__(
        ...
        self.production = ProductionClient(config)
