...
from cognite.powerops.clients.market.data_classes import RKOMMarket, RKOMMarketApply, RKOMMarketList
...
class RKOMMarketsAPI(TypeAPI[RKOMMarket, RKOMMarketApply, RKOMMarketList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "RKOMMarket", "42249a62597b27"),
