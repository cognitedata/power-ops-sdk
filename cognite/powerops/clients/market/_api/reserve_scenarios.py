...
from cognite.powerops.clients.market.data_classes import ReserveScenario, ReserveScenarioApply, ReserveScenarioList
...
class ReserveScenariosAPI(TypeAPI[ReserveScenario, ReserveScenarioApply, ReserveScenarioList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "ReserveScenario", "6f818998854739"),
