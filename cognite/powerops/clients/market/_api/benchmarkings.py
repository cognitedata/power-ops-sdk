...
from cognite.powerops.clients.market.data_classes import Benchmarking, BenchmarkingApply, BenchmarkingList
...
class BenchmarkingsAPI(TypeAPI[Benchmarking, BenchmarkingApply, BenchmarkingList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "Benchmarking", "c28c65e5b1270a"),
