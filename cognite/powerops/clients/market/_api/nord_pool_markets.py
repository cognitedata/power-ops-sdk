...
from cognite.powerops.clients.market.data_classes import NordPoolMarket, NordPoolMarketApply, NordPoolMarketList
...
class NordPoolMarketsAPI(TypeAPI[NordPoolMarket, NordPoolMarketApply, NordPoolMarketList]):
    def __init__(self, client: CogniteClient):
        super().__init__(
            client=client,
            sources=dm.ViewId("power-ops", "NordPoolMarket", "71fd70386f513a"),
    ...
    def list(self, limit: int = INSTANCES_LIST_LIMIT_DEFAULT) -> NordPoolMarketList:
