...
class CogReader:
    ...
    def _replace_model_time_series(self) -> None:
        ...
        mapping_data = self.cog_shop_case.retrieve_mapping_data(
            client=self.client, start=start, end=end, mappings=self.base_mapping
        )
        self.cog_shop_case.replace_time_series(mapping_data)
