...
# ! TODO: confirm that this does as intended
# ! -> Keep mappings that do not specify a time series in CDF? static mapping..
def filter_time_series_mappings(mapping: TimeSeriesMapping, client: CogniteClient) -> TimeSeriesMapping:
    ...
    # TODO: remove the checking of resources in cdf - do in validation step
