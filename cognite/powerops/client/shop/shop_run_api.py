...
class SHOPRunAPI:
    def __init__(self, client: CogniteClient, dataset_id: int, default_shop_version: str):
        self._cdf = client
        self._dataset_id = dataset_id
        self.default_shop_version = default_shop_version
    ...
    def trigger_case(self, case_file: str, watercourse: str) -> SHOPRun:
        ...
        new_event = SHOPRun(
            ...
            _shop_files=[],
            shop_version=self.default_shop_version,
            _client=self._cdf,
        )
    ...
    def _trigger_shop_container(self, event: SHOPRun):
        ...
        response = requests.post(
            url=self._shop_url(),
            json={
                "shopEventExternalId": event.external_id,
                "cogShopVersion": event.shop_version,
