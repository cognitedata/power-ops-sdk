...
class SHOPTableApply(DomainModelApply):
    ...
    def _to_instances_apply(
        ...
        write_view = (view_by_write_class and view_by_write_class.get(type(self))) or dm.ViewId(
            "power-ops-day-ahead-bids", "SHOPTable", "1"
        )
        ...
        edge_type = dm.DirectRelationReference("power-ops-day-ahead-bids", "SHOPTable.alerts")
        ...
        edge_type = dm.DirectRelationReference("power-ops-day-ahead-bids", "SHOPTable.productionPricePairs")
        for production_price_pair in self.production_price_pairs or []:
            other_resources = DomainRelationApply.from_edge_to_resources(
