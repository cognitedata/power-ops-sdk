    ...
    def apply(self, bid_table: BidTableApply | Sequence[BidTableApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new bid_table:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bids.data_classes import BidTableApply
    ...
    def retrieve(
        ...
        return self._retrieve(
            ...
            edge_api_name_type_triple=[
                (self.alerts_edge, "alerts", dm.DirectRelationReference("power-ops-day-ahead-bids", "BidTable.alerts")),
            ],
        )
