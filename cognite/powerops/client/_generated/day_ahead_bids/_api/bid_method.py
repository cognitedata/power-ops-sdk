...
from cognite.powerops.client._generated.day_ahead_bids.data_classes._bid_method import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new bid_method:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bids.data_classes import BidMethodApply
