...
from cognite.powerops.client._generated.day_ahead_bids.data_classes._water_value_based import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new water_value_based:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bids.data_classes import WaterValueBasedApply
