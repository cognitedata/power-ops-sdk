...
from cognite.powerops.client._generated.day_ahead_bids.data_classes._price_area import _create_price_area_filter
...
def _retrieve_timeseries_external_ids_with_extra_main_scenario(
    ...
    if isinstance(extra_properties, str):
        ...
        extra_list = extra_properties
    has_data = dm.filters.HasData([dm.ContainerId("power-ops-day-ahead-bids", "PriceArea")], [view_id])
