    ...
    def apply(
        ...
        Examples:
            ...
            Create a new bid_document:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bids.data_classes import BidDocumentApply
    ...
    def retrieve(
        ...
        return self._retrieve(
            ...
            edge_api_name_type_triple=[
                (self.alerts_edge, "alerts", dm.DirectRelationReference("power-ops-day-ahead-bids", "Bid.alerts")),
                (
                    self.partials_edge,
                    "partials",
