...
class PowerOpsModelsClient:
    """
    PowerOpsModelsClient
    ...
    def __init__(self, config_or_client: CogniteClient | ClientConfig):
        ...
        if not client.config.client_name.startswith("CognitePygen"):
            client.config.client_name = f"CognitePygen:1.2.23:SDK:{client.config.client_name}"
    ...
    @classmethod
    def from_toml(cls, file_path: Path | str, section: str | None = "cognite") -> PowerOpsModelsClient:
        import toml
