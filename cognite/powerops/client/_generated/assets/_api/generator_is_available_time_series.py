...
from cognite.powerops.client._generated.assets.data_classes._generator import _create_generator_filter
from ._core import DEFAULT_LIMIT_READ, INSTANCE_QUERY_LIMIT

ColumnNames = Literal["name", "displayName", "pMin", "penstock", "startCost", "startStopCost", "isAvailableTimeSeries"]
...
class GeneratorIsAvailableTimeSeriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `generator.is_available_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_is_available_time_series' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> generator_datapoints = client.generator.is_available_time_series(external_id="my_is_available_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `generator.is_available_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_is_available_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> generator_datapoints = client.generator.is_available_time_series(external_id="my_is_available_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `generator.is_available_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to isAvailableTimeSeries
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_is_available_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> generator_datapoints = client.generator.is_available_time_series(external_id="my_is_available_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `generator.is_available_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_is_available_time_series' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> from datetime import datetime, timezone
                >>> client = PowerAssetAPI()
                >>> generator_datapoints = client.generator.is_available_time_series(
                ...     external_id="my_is_available_time_series").retrieve_dataframe_in_timezone(
...
class GeneratorIsAvailableTimeSeriesAPI:
    ...
    def __call__(
        ...
        """Query timeseries `generator.is_available_time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the generator.is_available_time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 generator.is_available_time_series timeseries:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> generators = client.generator.is_available_time_series(limit=5).retrieve()
    ...
    def list(
        ...
        """List timeseries `generator.is_available_time_series`
        ...
        Returns:
            List of Timeseries generator.is_available_time_series.

        Examples:

            List generator.is_available_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> generators = client.generator.is_available_time_series.list(limit=5)
...
def _retrieve_timeseries_external_ids_with_extra_is_available_time_series(
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("isAvailableTimeSeries"))
