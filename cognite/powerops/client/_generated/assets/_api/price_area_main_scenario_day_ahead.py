...
class PriceAreaMainScenarioDayAheadQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area.main_scenario_day_ahead` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_main_scenario_day_ahead' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.main_scenario_day_ahead(external_id="my_main_scenario_day_ahead").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area.main_scenario_day_ahead` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_scenario_day_ahead' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.main_scenario_day_ahead(external_id="my_main_scenario_day_ahead").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "mainScenarioDayAhead",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `price_area.main_scenario_day_ahead` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to mainScenarioDayAhead
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_scenario_day_ahead' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.main_scenario_day_ahead(external_id="my_main_scenario_day_ahead").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area.main_scenario_day_ahead` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_main_scenario_day_ahead' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> from datetime import datetime, timezone
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.main_scenario_day_ahead(
                ...     external_id="my_main_scenario_day_ahead").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "mainScenarioDayAhead"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_main_scenario_day_ahead(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "mainScenarioDayAhead":
            return df
...
class PriceAreaMainScenarioDayAheadAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaMainScenarioDayAheadQuery:
        """Query timeseries `price_area.main_scenario_day_ahead`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area.main_scenario_day_ahead timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area.main_scenario_day_ahead timeseries:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_areas = client.price_area.main_scenario_day_ahead(limit=5).retrieve()
        ...
        return PriceAreaMainScenarioDayAheadQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area.main_scenario_day_ahead`
        ...
        Returns:
            List of Timeseries price_area.main_scenario_day_ahead.

        Examples:

            List price_area.main_scenario_day_ahead and limit to 5:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_areas = client.price_area.main_scenario_day_ahead.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_main_scenario_day_ahead(
...
def _retrieve_timeseries_external_ids_with_extra_main_scenario_day_ahead(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "mainScenarioDayAhead",
) -> dict[str, list[str]]:
    limit = float("inf") if limit is None or limit == -1 else limit
    properties = ["mainScenarioDayAhead"]
    if extra_properties == "mainScenarioDayAhead":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "mainScenarioDayAhead":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "mainScenarioDayAhead"])
    else:
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("mainScenarioDayAhead"))
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["mainScenarioDayAhead"]: [
