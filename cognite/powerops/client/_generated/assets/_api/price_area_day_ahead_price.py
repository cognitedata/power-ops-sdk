...
class PriceAreaDayAheadPriceQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area.day_ahead_price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_day_ahead_price' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.day_ahead_price(external_id="my_day_ahead_price").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area.day_ahead_price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_day_ahead_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.day_ahead_price(external_id="my_day_ahead_price").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area.day_ahead_price` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to dayAheadPrice
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_day_ahead_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.day_ahead_price(external_id="my_day_ahead_price").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area.day_ahead_price` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_day_ahead_price' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> from datetime import datetime, timezone
                >>> client = PowerAssetAPI()
                >>> price_area_datapoints = client.price_area.day_ahead_price(
                ...     external_id="my_day_ahead_price").retrieve_dataframe_in_timezone(
...
class PriceAreaDayAheadPriceAPI:
    ...
    def __call__(
        ...
        """Query timeseries `price_area.day_ahead_price`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area.day_ahead_price timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area.day_ahead_price timeseries:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_areas = client.price_area.day_ahead_price(limit=5).retrieve()
    ...
    def list(
        ...
        """List timeseries `price_area.day_ahead_price`
        ...
        Returns:
            List of Timeseries price_area.day_ahead_price.

        Examples:

            List price_area.day_ahead_price and limit to 5:

                >>> from cognite.powerops.client._generated.assets import PowerAssetAPI
                >>> client = PowerAssetAPI()
                >>> price_areas = client.price_area.day_ahead_price.list(limit=5)
...
def _retrieve_timeseries_external_ids_with_extra_day_ahead_price(
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("dayAheadPrice"))
