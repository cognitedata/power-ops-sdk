...
if TYPE_CHECKING:
    ...
    from cognite.powerops.client._generated.data_classes._price_production import (
        PriceProduction,
        PriceProductionList,
    ...
    from cognite.powerops.client._generated.data_classes._shop_based_partial_bid_configuration import (
...
class MultiScenarioPartialBidMatrixCalculationInput(PartialBidMatrixCalculationInput):
    ...
    price_production: Optional[list[Union[PriceProduction, str, dm.NodeId]]] = Field(
...
class MultiScenarioPartialBidMatrixCalculationInputWrite(PartialBidMatrixCalculationInputWrite):
    ...
    _outwards_edges: ClassVar[tuple[tuple[str, dm.DirectRelationReference], ...]] = (
        ("price_production", dm.DirectRelationReference("power_ops_types", "PriceProduction")),
    )
    ...
    price_production: Optional[list[Union[PriceProductionWrite, str, dm.NodeId]]] = Field(
        default=None, repr=False, alias="priceProduction"
    )
...
class MultiScenarioPartialBidMatrixCalculationInputList(DomainModelList[MultiScenarioPartialBidMatrixCalculationInput]):
    ...
    def partial_bid_configuration(self) -> ShopBasedPartialBidConfigurationList:
        ...
        return ShopBasedPartialBidConfigurationList(
            [
                item.partial_bid_configuration
                for item in self.data
                if isinstance(item.partial_bid_configuration, ShopBasedPartialBidConfiguration)
            ]
        )
    ...
    def price_production(self) -> PriceProductionList:
        ...
        return PriceProductionList(
            [item for items in self.data for item in items.price_production or [] if isinstance(item, PriceProduction)]
        )
...
class MultiScenarioPartialBidMatrixCalculationInputWriteList(
    ...
    def partial_bid_configuration(self) -> ShopBasedPartialBidConfigurationWriteList:
        ...
        return ShopBasedPartialBidConfigurationWriteList(
            [
                item.partial_bid_configuration
                for item in self.data
                if isinstance(item.partial_bid_configuration, ShopBasedPartialBidConfigurationWrite)
            ]
        )
    ...
    def price_production(self) -> PriceProductionWriteList:
        ...
        return PriceProductionWriteList(
            [
                item
                for items in self.data
                for item in items.price_production or []
                if isinstance(item, PriceProductionWrite)
            ]
        )
...
class _MultiScenarioPartialBidMatrixCalculationInputQuery(
    NodeQueryCore[T_DomainModelList, MultiScenarioPartialBidMatrixCalculationInputList]
):
    ...
    def __init__(
        ...
        if (
            _ShopBasedPartialBidConfigurationQuery not in created_types
            and len(creation_path) + 1 < global_config.max_select_depth
        ):
    ...
    def list_multi_scenario_partial_bid_matrix_calculation_input(
        self, limit: int = DEFAULT_QUERY_LIMIT
    ) -> MultiScenarioPartialBidMatrixCalculationInputList:
        return self._list(limit=limit)


class MultiScenarioPartialBidMatrixCalculationInputQuery(
    _MultiScenarioPartialBidMatrixCalculationInputQuery[MultiScenarioPartialBidMatrixCalculationInputList]
):
