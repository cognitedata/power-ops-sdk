...
if TYPE_CHECKING:
    from cognite.powerops.client.data_classes._benchmark_bids import BenchmarkBidApply
    from cognite.powerops.client.data_classes._production_plan_time_series import ProductionPlanTimeSeriesApply
...
class BenchmarkProcesApply(DomainModelApply):
    ...
    def _to_instances_apply(self, cache: set[str]) -> dm.InstancesApply:
        ...
        if properties:
            source = dm.NodeOrEdgeData(source=dm.ContainerId("power-ops", "BenchmarkProcess"), properties=properties)
