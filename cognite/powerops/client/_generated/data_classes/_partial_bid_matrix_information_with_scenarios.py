...
from cognite.powerops.client._generated.data_classes._partial_bid_matrix_information import (
...
if TYPE_CHECKING:
    ...
    from cognite.powerops.client._generated.data_classes._partial_bid_configuration import (
...
PartialBidMatrixInformationWithScenariosFields = Literal[
    "external_id", "state", "bid_matrix", "linked_time_series", "resource_cost"
]
...
class PartialBidMatrixInformationWithScenarios(PartialBidMatrixInformation):
    ...
    multi_scenario_input: Optional[list[Union[PriceProduction, str, dm.NodeId]]] = Field(
        default=None, repr=False, alias="multiScenarioInput"
    )
...
class PartialBidMatrixInformationWithScenariosWrite(PartialBidMatrixInformationWrite):
    ...
    _outwards_edges: ClassVar[tuple[tuple[str, dm.DirectRelationReference], ...]] = (
        ...
        ("multi_scenario_input", dm.DirectRelationReference("power_ops_types", "calculationIssue")),
    ...
    multi_scenario_input: Optional[list[Union[PriceProductionWrite, str, dm.NodeId]]] = Field(
        default=None, repr=False, alias="multiScenarioInput"
    )
    ...
    def multi_scenario_input(self) -> PriceProductionList:
        ...
        return PriceProductionList(
            [
                ...
                for item in items.multi_scenario_input or []
                if isinstance(item, PriceProduction)
            ]
        )
...
class _PartialBidMatrixInformationWithScenariosQuery(
    NodeQueryCore[T_DomainModelList, PartialBidMatrixInformationWithScenariosList]
):
    ...
    def list_partial_bid_matrix_information_with_scenario(
        self, limit: int = DEFAULT_QUERY_LIMIT
    ) -> PartialBidMatrixInformationWithScenariosList:
        return self._list(limit=limit)


class PartialBidMatrixInformationWithScenariosQuery(
    _PartialBidMatrixInformationWithScenariosQuery[PartialBidMatrixInformationWithScenariosList]
):
