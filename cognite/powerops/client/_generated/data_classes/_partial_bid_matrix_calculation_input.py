...
PartialBidMatrixCalculationInputTextFields = Literal[
...
class _PartialBidMatrixCalculationInputQuery(NodeQueryCore[T_DomainModelList, PartialBidMatrixCalculationInputList]):
    ...
    def list_partial_bid_matrix_calculation_input(
        self, limit: int = DEFAULT_QUERY_LIMIT
    ) -> PartialBidMatrixCalculationInputList:
        return self._list(limit=limit)


class PartialBidMatrixCalculationInputQuery(
    _PartialBidMatrixCalculationInputQuery[PartialBidMatrixCalculationInputList]
):
