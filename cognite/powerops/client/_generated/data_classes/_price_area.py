...
PriceAreaTextFields = Literal["name", "description", "day_ahead_price_time_series"]
PriceAreaFields = Literal["name", "description", "day_ahead_price_time_series"]

_PRICEAREA_PROPERTIES_BY_FIELD = {
    "name": "name",
    "description": "description",
    "day_ahead_price_time_series": "dayAheadPriceTimeSeries",
}
...
class PriceArea(DomainModel):
    ...
    day_ahead_price_time_series: Optional[str] = Field(None, alias="dayAheadPriceTimeSeries")
    ...
    def as_apply(self) -> PriceAreaApply:
        return PriceAreaApply(
            ...
            day_ahead_price_time_series=self.day_ahead_price_time_series,
            plants=self.plants,
...
class PriceAreaApply(DomainModelApply):
    ...
    def _to_instances_apply(self, cache: set[str]) -> dm.InstancesApply:
        ...
        if self.day_ahead_price_time_series is not None:
            properties["dayAheadPriceTimeSeries"] = self.day_ahead_price_time_series
        if properties:
