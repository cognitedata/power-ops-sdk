...
from cognite.powerops.client._generated.data_classes._bid_matrix_information import BidMatrixInformation, BidMatrixInformationWrite
if TYPE_CHECKING:
    ...
    from cognite.powerops.client._generated.data_classes._partial_bid_configuration import PartialBidConfiguration, PartialBidConfigurationList, PartialBidConfigurationGraphQL, PartialBidConfigurationWrite, PartialBidConfigurationWriteList
    from cognite.powerops.client._generated.data_classes._power_asset import PowerAsset, PowerAssetList, PowerAssetGraphQL, PowerAssetWrite, PowerAssetWriteList
...
PartialBidMatrixInformationTextFields = Literal["external_id", "state", "bid_matrix", "linked_time_series"]
PartialBidMatrixInformationFields = Literal["external_id", "state", "bid_matrix", "linked_time_series", "resource_cost"]
...
class PartialBidMatrixInformationGraphQL(GraphQLCore):
    ...
    view_id: ClassVar[dm.ViewId] = dm.ViewId("power_ops_core", "PartialBidMatrixInformation", "1")
    ...
    def as_read(self) -> PartialBidMatrixInformation:
        ...
        return PartialBidMatrixInformation.model_validate(as_read_args(self))
...
class _PartialBidMatrixInformationQuery(NodeQueryCore[T_DomainModelList, PartialBidMatrixInformationList]):
    _view_id = PartialBidMatrixInformation._view_id
    _result_cls = PartialBidMatrixInformation
    _result_list_cls_end = PartialBidMatrixInformationList
...
class PartialBidMatrixInformationQuery(_PartialBidMatrixInformationQuery[PartialBidMatrixInformationList]):
    def __init__(self, client: CogniteClient):
        super().__init__(set(), [], client, PartialBidMatrixInformationList)
