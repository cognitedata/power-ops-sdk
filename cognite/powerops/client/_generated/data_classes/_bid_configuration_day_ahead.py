...
if TYPE_CHECKING:
    from cognite.powerops.client._generated.data_classes._date_specification import (
        DateSpecification,
    ...
    from cognite.powerops.client._generated.data_classes._market_configuration import (
        MarketConfiguration,
