...
from cognite.powerops.client._generated.data_classes._core.query.constants import DATA_RECORD_PROPERTIES
from cognite.powerops.client._generated.data_classes._core.query.step import QueryResultStep
