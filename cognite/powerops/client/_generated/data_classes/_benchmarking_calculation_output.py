...
if TYPE_CHECKING:
    ...
    from cognite.powerops.client._generated.data_classes._benchmarking_calculation_input import BenchmarkingCalculationInput, BenchmarkingCalculationInputList, BenchmarkingCalculationInputGraphQL, BenchmarkingCalculationInputWrite, BenchmarkingCalculationInputWriteList
    from cognite.powerops.client._generated.data_classes._benchmarking_result_day_ahead import BenchmarkingResultDayAhead, BenchmarkingResultDayAheadList, BenchmarkingResultDayAheadGraphQL, BenchmarkingResultDayAheadWrite, BenchmarkingResultDayAheadWriteList
