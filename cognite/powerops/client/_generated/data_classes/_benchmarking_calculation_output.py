...
if TYPE_CHECKING:
    ...
    from cognite.powerops.client._generated.data_classes._benchmarking_calculation_input import (
    ...
    from cognite.powerops.client._generated.data_classes._benchmarking_result_day_ahead import (
