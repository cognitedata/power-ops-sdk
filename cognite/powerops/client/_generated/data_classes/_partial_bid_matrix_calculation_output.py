...
from cognite.powerops.client._generated.data_classes._function_output import FunctionOutput, FunctionOutputWrite
if TYPE_CHECKING:
    from cognite.powerops.client._generated.data_classes._alert import Alert, AlertList, AlertGraphQL, AlertWrite, AlertWriteList
    from cognite.powerops.client._generated.data_classes._bid_configuration_day_ahead import BidConfigurationDayAhead, BidConfigurationDayAheadList, BidConfigurationDayAheadGraphQL, BidConfigurationDayAheadWrite, BidConfigurationDayAheadWriteList
    from cognite.powerops.client._generated.data_classes._bid_matrix import BidMatrix, BidMatrixList, BidMatrixGraphQL, BidMatrixWrite, BidMatrixWriteList
    from cognite.powerops.client._generated.data_classes._partial_bid_matrix_calculation_input import PartialBidMatrixCalculationInput, PartialBidMatrixCalculationInputList, PartialBidMatrixCalculationInputGraphQL, PartialBidMatrixCalculationInputWrite, PartialBidMatrixCalculationInputWriteList
...
class PartialBidMatrixCalculationOutputGraphQL(GraphQLCore):
    ...
    def as_read(self) -> PartialBidMatrixCalculationOutput:
        ...
        return PartialBidMatrixCalculationOutput.model_validate(as_read_args(self))
    ...
    def as_write(self) -> PartialBidMatrixCalculationOutputWrite:
        ...
        return PartialBidMatrixCalculationOutputWrite.model_validate(as_write_args(self))
...
class PartialBidMatrixCalculationOutput(FunctionOutput):
    ...
    function_input: Union[PartialBidMatrixCalculationInput, str, dm.NodeId, None] = Field(default=None, repr=False, alias="functionInput")
    ...
    @field_validator("function_input", "partial_matrix", "bid_configuration", mode="before")
    @classmethod
...
class PartialBidMatrixCalculationOutputWrite(FunctionOutputWrite):
    ...
    Args:
        ...
        bid_configuration: The bid configuration field.
    """
    _container_fields: ClassVar[tuple[str, ...]] = ("bid_configuration", "function_call_id", "function_input", "function_name", "partial_matrix", "workflow_execution_id", "workflow_step",)
    ...
    _direct_relations: ClassVar[tuple[str, ...]] = ("bid_configuration", "function_input", "partial_matrix",)
    ...
    function_input: Union[PartialBidMatrixCalculationInputWrite, str, dm.NodeId, None] = Field(default=None, repr=False, alias="functionInput")
...
class _PartialBidMatrixCalculationOutputQuery(NodeQueryCore[T_DomainModelList, PartialBidMatrixCalculationOutputList]):
    ...
    def __init__(
        ...
        if _PartialBidMatrixCalculationInputQuery not in created_types and len(creation_path) + 1 < global_config.max_select_depth:
        ...
        if _BidMatrixQuery not in created_types and len(creation_path) + 1 < global_config.max_select_depth:
            self.partial_matrix = _BidMatrixQuery(
                ...
                connection_property=ViewPropertyId(self._view_id, "partialMatrix"),
            )
        ...
        self.partial_matrix_filter = DirectRelationFilter(self, self._view_id.as_property_ref("partialMatrix"))
