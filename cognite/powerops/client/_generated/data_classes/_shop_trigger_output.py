...
ShopTriggerOutputFields = Literal[
...
class ShopTriggerOutput(FunctionOutput):
    ...
    function_input: Union[ShopTriggerInput, str, dm.NodeId, None] = Field(
...
class ShopTriggerOutputWrite(FunctionOutputWrite):
    ...
    function_input: Union[ShopTriggerInputWrite, str, dm.NodeId, None] = Field(
        default=None, repr=False, alias="functionInput"
    )
...
class ShopTriggerOutputList(DomainModelList[ShopTriggerOutput]):
    ...
    def function_input(self) -> ShopTriggerInputList:
        ...
        return ShopTriggerInputList(
            [item.function_input for item in self.data if isinstance(item.function_input, ShopTriggerInput)]
        )
...
class ShopTriggerOutputWriteList(DomainModelWriteList[ShopTriggerOutputWrite]):
    ...
    def function_input(self) -> ShopTriggerInputWriteList:
        ...
        return ShopTriggerInputWriteList(
            [item.function_input for item in self.data if isinstance(item.function_input, ShopTriggerInputWrite)]
        )
