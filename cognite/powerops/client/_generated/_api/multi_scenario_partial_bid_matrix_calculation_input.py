...
from cognite.powerops.client._generated.data_classes._multi_scenario_partial_bid_matrix_calculation_input import (
...
class MultiScenarioPartialBidMatrixCalculationInputAPI(
    ...
    _properties_by_field: ClassVar[dict[str, str]] = _MULTISCENARIOPARTIALBIDMATRIXCALCULATIONINPUT_PROPERTIES_BY_FIELD
    ...
    def retrieve(
        ...
        Examples:
            ...
            Retrieve multi_scenario_partial_bid_matrix_calculation_input by id:
                ...
                >>> multi_scenario_partial_bid_matrix_calculation_input = client.multi_scenario_partial_bid_matrix_calculation_input.retrieve(
                ...     "my_multi_scenario_partial_bid_matrix_calculation_input"
                ... )
    ...
    def search(
        ...
        properties: (
            MultiScenarioPartialBidMatrixCalculationInputTextFields
            | SequenceNotStr[MultiScenarioPartialBidMatrixCalculationInputTextFields]
            | None
        ) = None,
        ...
        sort_by: (
            MultiScenarioPartialBidMatrixCalculationInputFields
            | SequenceNotStr[MultiScenarioPartialBidMatrixCalculationInputFields]
            | None
        ) = None,
        ...
        Examples:
           ...
           Search for 'my_multi_scenario_partial_bid_matrix_calculation_input' in all text properties:
                ...
                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> multi_scenario_partial_bid_matrix_calculation_inputs = client.multi_scenario_partial_bid_matrix_calculation_input.search(
                ...     'my_multi_scenario_partial_bid_matrix_calculation_input'
                ... )
    ...
    def histogram(
        ...
        Args:
            ...
            external_id_prefix: The prefix of the external ID to filter on.
            space: The space to filter on.
            limit: Maximum number of multi scenario partial bid matrix calculation inputs to return.
    ...
    def _build(
        ...
        if retrieve_connections == "full":
            ...
            builder.extend(
                factory.from_direct_relation(
                    ShopBasedPartialBidConfiguration._view_id,
