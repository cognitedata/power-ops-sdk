...
class BenchmarkingCalculationOutputBenchmarkingResultsAPI(EdgeAPI):
    def list(
        ...
        Args:
            ...
            limit: Maximum number of benchmarking result edges to return. Defaults to 25.
        ...
        Examples:
            ...
            List 5 benchmarking result edges connected to "my_benchmarking_calculation_output":
                ...
                >>> benchmarking_calculation_output = client.benchmarking_calculation_output.benchmarking_results_edge.list(
