...
class PartialBidMatrixInformationAlertsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List alert edges of a partial bid matrix information.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_partial_bid_matrix_information":

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> partial_bid_matrix_information = client.partial_bid_matrix_information.alerts_edge.list(
