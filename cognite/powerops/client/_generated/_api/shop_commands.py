...
class ShopCommandsAPI(NodeAPI[ShopCommands, ShopCommandsWrite, ShopCommandsList, ShopCommandsWriteList]):
    ...
    _properties_by_field: ClassVar[dict[str, str]] = _SHOPCOMMANDS_PROPERTIES_BY_FIELD
    ...
    def retrieve(
        ...
        Examples:
            ...
            Retrieve shop_command by id:
                ...
                >>> shop_command = client.shop_commands.retrieve(
                ...     "my_shop_command"
                ... )
    ...
    def search(
        ...
        Args:
            ...
            limit: Maximum number of shop commands to return. Defaults to 25.
        ...
        Examples:
           ...
           Search for 'my_shop_command' in all text properties:
                ...
                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> shop_commands = client.shop_commands.search(
                ...     'my_shop_command'
                ... )
    ...
    def histogram(
        ...
        Args:
            ...
            external_id_prefix: The prefix of the external ID to filter on.
            space: The space to filter on.
            limit: Maximum number of shop commands to return.
    ...
    ) -> Iterator[ShopCommandsList]:
        """Iterate over shop commands

        Args:
            chunk_size: The number of shop commands to return in each iteration. Defaults to 100.
            name: The name to filter on.
            name_prefix: The prefix of the name to filter on.
            external_id_prefix: The prefix of the external ID to filter on.
            space: The space to filter on.
            filter: (Advanced) If the filtering available in the above is not sufficient,
                you can write your own filtering which will be ANDed with the filter above.
            limit: Maximum number of shop commands to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of shop commands

        Examples:

            Iterate shop commands in chunks of 100 up to 2000 items:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_commands in client.shop_commands.iterate(chunk_size=100, limit=2000):
                ...     for shop_command in shop_commands:
                ...         print(shop_command.external_id)

            Iterate shop commands in chunks of 100 sorted by external_id in descending order:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_commands in client.shop_commands.iterate(
                ...     chunk_size=100,
                ...     sort_by="external_id",
            ...
            Iterate shop commands in chunks of 100 and use cursors to resume the iteration:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for first_iteration in client.shop_commands.iterate(chunk_size=100, limit=2000):
