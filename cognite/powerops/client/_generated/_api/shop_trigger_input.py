...
from cognite.powerops.client._generated.data_classes._shop_trigger_input import (
...
class ShopTriggerInputAPI(
    NodeAPI[ShopTriggerInput, ShopTriggerInputWrite, ShopTriggerInputList, ShopTriggerInputWriteList]
):
    _view_id = dm.ViewId("power_ops_core", "ShopTriggerInput", "1")
    _properties_by_field: ClassVar[dict[str, str]] = _SHOPTRIGGERINPUT_PROPERTIES_BY_FIELD
    ...
    def retrieve(
        ...
        Examples:
            ...
            Retrieve shop_trigger_input by id:
                ...
                >>> shop_trigger_input = client.shop_trigger_input.retrieve(
                ...     "my_shop_trigger_input"
                ... )
    ...
    def search(
        ...
        Examples:
           ...
           Search for 'my_shop_trigger_input' in all text properties:
                ...
                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> shop_trigger_inputs = client.shop_trigger_input.search(
                ...     'my_shop_trigger_input'
                ... )
    ...
    ) -> Iterator[ShopTriggerInputList]:
        """Iterate over shop trigger inputs

        Args:
            chunk_size: The number of shop trigger inputs to return in each iteration. Defaults to 100.
            workflow_execution_id: The workflow execution id to filter on.
            workflow_execution_id_prefix: The prefix of the workflow execution id to filter on.
            min_workflow_step: The minimum value of the workflow step to filter on.
            max_workflow_step: The maximum value of the workflow step to filter on.
            ...
            Defaults to 'skip'.'skip' will not retrieve any connections, 'identifier' will only retrieve the identifier
            of the connected items, and 'full' will retrieve the full connected items.
            limit: Maximum number of shop trigger inputs to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of shop trigger inputs

        Examples:

            Iterate shop trigger inputs in chunks of 100 up to 2000 items:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_trigger_inputs in client.shop_trigger_input.iterate(chunk_size=100, limit=2000):
                ...     for shop_trigger_input in shop_trigger_inputs:
                ...         print(shop_trigger_input.external_id)

            Iterate shop trigger inputs in chunks of 100 sorted by external_id in descending order:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_trigger_inputs in client.shop_trigger_input.iterate(
                ...     chunk_size=100,
                ...     sort_by="external_id",
            ...
            Iterate shop trigger inputs in chunks of 100 and use cursors to resume the iteration:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for first_iteration in client.shop_trigger_input.iterate(chunk_size=100, limit=2000):
