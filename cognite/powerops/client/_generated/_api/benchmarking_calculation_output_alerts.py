...
class BenchmarkingCalculationOutputAlertsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List alert edges of a benchmarking calculation output.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_benchmarking_calculation_output":

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> benchmarking_calculation_output = client.benchmarking_calculation_output.alerts_edge.list(
                ...     "my_benchmarking_calculation_output", limit=5
                ... )
