...
from cognite.powerops.client._generated.data_classes._price_area import (
    PriceAreaQuery,
...
class PriceAreaAPI(NodeAPI[PriceArea, PriceAreaWrite, PriceAreaList, PriceAreaWriteList]):
    ...
    def search(
        self,
        query: str,
        properties: PriceAreaTextFields | SequenceNotStr[PriceAreaTextFields] | None = None,
        ...
        sort_by: PriceAreaFields | SequenceNotStr[PriceAreaFields] | None = None,
    ...
    def aggregate(
        ...
        group_by: None = None,
        property: PriceAreaFields | SequenceNotStr[PriceAreaFields] | None = None,
        query: str | None = None,
        search_property: PriceAreaTextFields | SequenceNotStr[PriceAreaTextFields] | None = None,
        name: str | list[str] | None = None,
        name_prefix: str | None = None,
        display_name: str | list[str] | None = None,
        display_name_prefix: str | None = None,
    ...
    def aggregate(
        ...
        group_by: PriceAreaFields | SequenceNotStr[PriceAreaFields],
        property: PriceAreaFields | SequenceNotStr[PriceAreaFields] | None = None,
        query: str | None = None,
        search_property: PriceAreaTextFields | SequenceNotStr[PriceAreaTextFields] | None = None,
        name: str | list[str] | None = None,
    ...
    def aggregate(
        ...
        | dm.aggregations.MetricAggregation
        | SequenceNotStr[Aggregations | dm.aggregations.MetricAggregation],
        group_by: PriceAreaFields | SequenceNotStr[PriceAreaFields] | None = None,
        property: PriceAreaFields | SequenceNotStr[PriceAreaFields] | None = None,
        query: str | None = None,
        search_property: PriceAreaTextFields | SequenceNotStr[PriceAreaTextFields] | None = None,
        name: str | list[str] | None = None,
    ...
    ) -> Iterator[PriceAreaList]:
        """Iterate over price areas

        Args:
            chunk_size: The number of price areas to return in each iteration. Defaults to 100.
            name: The name to filter on.
            name_prefix: The prefix of the name to filter on.
            display_name: The display name to filter on.
            display_name_prefix: The prefix of the display name to filter on.
            ...
            filter: (Advanced) If the filtering available in the above is not sufficient,
                you can write your own filtering which will be ANDed with the filter above.
            limit: Maximum number of price areas to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of price areas

        Examples:

            Iterate price areas in chunks of 100 up to 2000 items:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for price_areas in client.price_area.iterate(chunk_size=100, limit=2000):
                ...     for price_area in price_areas:
                ...         print(price_area.external_id)

            Iterate price areas in chunks of 100 sorted by external_id in descending order:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for price_areas in client.price_area.iterate(
                ...     chunk_size=100,
                ...     sort_by="external_id",
            ...
            Iterate price areas in chunks of 100 and use cursors to resume the iteration:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for first_iteration in client.price_area.iterate(chunk_size=100, limit=2000):
    ...
    def list(
        ...
        limit: int = DEFAULT_LIMIT_READ,
        filter: dm.Filter | None = None,
        sort_by: PriceAreaFields | Sequence[PriceAreaFields] | None = None,
        direction: Literal["ascending", "descending"] = "ascending",
        sort: InstanceSort | list[InstanceSort] | None = None,
    ) -> PriceAreaList:
