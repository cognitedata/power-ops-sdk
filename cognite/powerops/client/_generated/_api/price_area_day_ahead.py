...
class PriceAreaDayAheadAPI(
    NodeAPI[PriceAreaDayAhead, PriceAreaDayAheadWrite, PriceAreaDayAheadList, PriceAreaDayAheadWriteList]
):
    ...
    ) -> Iterator[PriceAreaDayAheadList]:
        """Iterate over price area day aheads

        Args:
            chunk_size: The number of price area day aheads to return in each iteration. Defaults to 100.
            name: The name to filter on.
            name_prefix: The prefix of the name to filter on.
            display_name: The display name to filter on.
            display_name_prefix: The prefix of the display name to filter on.
            ...
            Defaults to 'skip'.'skip' will not retrieve any connections, 'identifier' will only retrieve the identifier
            of the connected items, and 'full' will retrieve the full connected items.
            limit: Maximum number of price area day aheads to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of price area day aheads

        Examples:

            Iterate price area day aheads in chunks of 100 up to 2000 items:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for price_area_day_aheads in client.price_area_day_ahead.iterate(chunk_size=100, limit=2000):
                ...     for price_area_day_ahead in price_area_day_aheads:
                ...         print(price_area_day_ahead.external_id)

            Iterate price area day aheads in chunks of 100 sorted by external_id in descending order:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for price_area_day_aheads in client.price_area_day_ahead.iterate(
                ...     chunk_size=100,
                ...     sort_by="external_id",
            ...
            Iterate price area day aheads in chunks of 100 and use cursors to resume the iteration:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for first_iteration in client.price_area_day_ahead.iterate(chunk_size=100, limit=2000):
