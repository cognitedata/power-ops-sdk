...
class BenchmarkingCalculationInputShopResultsAPI(EdgeAPI):
    def list(
        ...
        Args:
            ...
            limit: Maximum number of shop result edges to return. Defaults to 25.
        ...
        Examples:
            ...
            List 5 shop result edges connected to "my_benchmarking_calculation_input":
                ...
                >>> benchmarking_calculation_input = client.benchmarking_calculation_input.shop_results_edge.list(
                ...     "my_benchmarking_calculation_input", limit=5
                ... )
