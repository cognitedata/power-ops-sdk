...
class MultiScenarioPartialBidMatrixCalculationInputPriceProductionAPI(EdgeAPI):
    def list(
        ...
        Args:
            ...
            limit: Maximum number of price production edges to return. Defaults to 25.
        ...
        Examples:
            ...
            List 5 price production edges connected to "my_multi_scenario_partial_bid_matrix_calculation_input":
                ...
                >>> multi_scenario_partial_bid_matrix_calculation_input = client.multi_scenario_partial_bid_matrix_calculation_input.price_production_edge.list(
                ...     "my_multi_scenario_partial_bid_matrix_calculation_input", limit=5
                ... )
