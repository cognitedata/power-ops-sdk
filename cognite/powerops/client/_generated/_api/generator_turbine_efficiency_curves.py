...
class GeneratorTurbineEfficiencyCurvesAPI(EdgeAPI):
    def list(
        ...
        Args:
            ...
            limit: Maximum number of turbine efficiency curve edges to return. Defaults to 25.
        ...
        Examples:
            ...
            List 5 turbine efficiency curve edges connected to "my_generator":
                ...
                >>> generator = client.generator.turbine_efficiency_curves_edge.list(
                ...     "my_generator", limit=5
                ... )
