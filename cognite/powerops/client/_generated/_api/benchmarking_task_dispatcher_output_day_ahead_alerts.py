...
class BenchmarkingTaskDispatcherOutputDayAheadAlertsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List alert edges of a benchmarking task dispatcher output day ahead.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_benchmarking_task_dispatcher_output_day_ahead":
