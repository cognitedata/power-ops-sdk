...
class ShopTimeResolutionAPI(NodeAPI[ShopTimeResolution, ShopTimeResolutionWrite, ShopTimeResolutionList, ShopTimeResolutionWriteList]):
    ...
    def retrieve(
        ...
        space: str = DEFAULT_INSTANCE_SPACE,
    ) -> ShopTimeResolution | ShopTimeResolutionList | None:
        ...
        Examples:
            ...
            Retrieve shop_time_resolution by id:
                ...
                >>> shop_time_resolution = client.shop_time_resolution.retrieve(
                ...     "my_shop_time_resolution"
                ... )
    ...
    def search(
        ...
        Args:
            ...
            limit: Maximum number of shop time resolutions to return. Defaults to 25.
        ...
        Examples:
           ...
           Search for 'my_shop_time_resolution' in all text properties:
                ...
                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> shop_time_resolutions = client.shop_time_resolution.search(
                ...     'my_shop_time_resolution'
                ... )
    ...
    def histogram(
        ...
        Args:
            ...
            external_id_prefix: The prefix of the external ID to filter on.
            space: The space to filter on.
            limit: Maximum number of shop time resolutions to return.
    ...
    ) -> Iterator[ShopTimeResolutionList]:
        """Iterate over shop time resolutions

        Args:
            chunk_size: The number of shop time resolutions to return in each iteration. Defaults to 100.
            name: The name to filter on.
            name_prefix: The prefix of the name to filter on.
            external_id_prefix: The prefix of the external ID to filter on.
            space: The space to filter on.
            filter: (Advanced) If the filtering available in the above is not sufficient,
                you can write your own filtering which will be ANDed with the filter above.
            limit: Maximum number of shop time resolutions to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of shop time resolutions

        Examples:

            Iterate shop time resolutions in chunks of 100 up to 2000 items:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_time_resolutions in client.shop_time_resolution.iterate(chunk_size=100, limit=2000):
                ...     for shop_time_resolution in shop_time_resolutions:
                ...         print(shop_time_resolution.external_id)

            Iterate shop time resolutions in chunks of 100 sorted by external_id in descending order:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for shop_time_resolutions in client.shop_time_resolution.iterate(
                ...     chunk_size=100,
                ...     sort_by="external_id",
            ...
            Iterate shop time resolutions in chunks of 100 and use cursors to resume the iteration:

                >>> from cognite.powerops.client._generated import PowerOpsModelsClient
                >>> client = PowerOpsModelsClient()
                >>> for first_iteration in client.shop_time_resolution.iterate(chunk_size=100, limit=2000):
