...
from cognite.powerops.client._generated.production.data_classes._plant import (
    ...
    def apply(self, plant: PlantApply | Sequence[PlantApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new plant:
                ...
                >>> from cognite.powerops.client._generated.production.data_classes import PlantApply
