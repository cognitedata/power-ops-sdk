...
from cognite.powerops.client._generated.production.data_classes._plant import _create_plant_filter
...
class PlantWaterValueTimeSeriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `plant.water_value_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_water_value_time_series' from 2 weeks ago up until now::
                ...
                >>> plant_datapoints = client.plant.water_value_time_series(external_id="my_water_value_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `plant.water_value_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_water_value_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> plant_datapoints = client.plant.water_value_time_series(external_id="my_water_value_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `plant.water_value_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_water_value_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> plant_datapoints = client.plant.water_value_time_series(external_id="my_water_value_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `plant.water_value_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_water_value_time_series' for the first month of 2023 in Oslo time:
                ...
                >>> client = ProductionModelAPI()
                >>> plant_datapoints = client.plant.water_value_time_series(
...
class PlantWaterValueTimeSeriesAPI:
    ...
    def __call__(
        ...
        Examples:
            ...
            Retrieve all data for 5 plant.water_value_time_series timeseries:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> plants = client.plant.water_value_time_series(limit=5).retrieve()
    ...
    def list(
        ...
        Examples:
            ...
            List plant.water_value_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> plants = client.plant.water_value_time_series.list(limit=5)
