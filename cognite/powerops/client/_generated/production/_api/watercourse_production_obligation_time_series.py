...
class WatercourseProductionObligationTimeSeriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `watercourse.production_obligation_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_production_obligation_time_series' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> watercourse_datapoints = client.watercourse.production_obligation_time_series(external_id="my_production_obligation_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `watercourse.production_obligation_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_obligation_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> watercourse_datapoints = client.watercourse.production_obligation_time_series(external_id="my_production_obligation_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "productionObligationTimeSeries",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `watercourse.production_obligation_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to productionObligationTimeSeries
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_obligation_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> watercourse_datapoints = client.watercourse.production_obligation_time_series(external_id="my_production_obligation_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `watercourse.production_obligation_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_production_obligation_time_series' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> from datetime import datetime, timezone
                >>> client = ProductionModelAPI()
                >>> watercourse_datapoints = client.watercourse.production_obligation_time_series(
                ...     external_id="my_production_obligation_time_series").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "productionObligationTimeSeries"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_production_obligation_time_series(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "productionObligationTimeSeries":
            return df
...
class WatercourseProductionObligationTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> WatercourseProductionObligationTimeSeriesQuery:
        """Query timeseries `watercourse.production_obligation_time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the watercourse.production_obligation_time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 watercourse.production_obligation_time_series timeseries:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> watercourses = client.watercourse.production_obligation_time_series(limit=5).retrieve()
        ...
        return WatercourseProductionObligationTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `watercourse.production_obligation_time_series`
        ...
        Returns:
            List of Timeseries watercourse.production_obligation_time_series.

        Examples:

            List watercourse.production_obligation_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> watercourses = client.watercourse.production_obligation_time_series.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_production_obligation_time_series(
...
def _retrieve_timeseries_external_ids_with_extra_production_obligation_time_series(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "productionObligationTimeSeries",
) -> dict[str, list[str]]:
    limit = float("inf") if limit is None or limit == -1 else limit
    properties = ["productionObligationTimeSeries"]
    if extra_properties == "productionObligationTimeSeries":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "productionObligationTimeSeries":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "productionObligationTimeSeries"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["productionObligationTimeSeries"]: [
