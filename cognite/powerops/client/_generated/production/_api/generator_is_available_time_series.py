...
from cognite.powerops.client._generated.production.data_classes._generator import _create_generator_filter
...
class GeneratorIsAvailableTimeSeriesAPI:
    ...
    def __call__(
        ...
        Args:
            ...
            min_startcost: The minimum value of the startcost to filter on.
            max_startcost: The maximum value of the startcost to filter on.
