...
from cognite.powerops.client._generated.production.data_classes._price_area import _create_price_area_filter
...
class PriceAreaDayaheadPriceTimeSeriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area.dayahead_price_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_dayahead_price_time_series' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> price_area_datapoints = client.price_area.dayahead_price_time_series(external_id="my_dayahead_price_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area.dayahead_price_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_dayahead_price_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> price_area_datapoints = client.price_area.dayahead_price_time_series(external_id="my_dayahead_price_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area.dayahead_price_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to dayaheadPriceTimeSeries
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_dayahead_price_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> price_area_datapoints = client.price_area.dayahead_price_time_series(external_id="my_dayahead_price_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area.dayahead_price_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_dayahead_price_time_series' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> from datetime import datetime, timezone
                >>> client = ProductionModelAPI()
                >>> price_area_datapoints = client.price_area.dayahead_price_time_series(
                ...     external_id="my_dayahead_price_time_series").retrieve_dataframe_in_timezone(
...
class PriceAreaDayaheadPriceTimeSeriesAPI:
    ...
    def __call__(
        ...
        """Query timeseries `price_area.dayahead_price_time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area.dayahead_price_time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area.dayahead_price_time_series timeseries:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> price_areas = client.price_area.dayahead_price_time_series(limit=5).retrieve()
    ...
    def list(
        ...
        """List timeseries `price_area.dayahead_price_time_series`
        ...
        Returns:
            List of Timeseries price_area.dayahead_price_time_series.

        Examples:

            List price_area.dayahead_price_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.production import ProductionModelAPI
                >>> client = ProductionModelAPI()
                >>> price_areas = client.price_area.dayahead_price_time_series.list(limit=5)
