...
from cognite.powerops.client._generated.production.data_classes._watercourse import (
...
from .watercourse_production_obligation_time_series import WatercourseProductionObligationTimeSeriesAPI
...
class WatercourseAPI(NodeAPI[Watercourse, WatercourseApply, WatercourseList]):
    def __init__(self, client: CogniteClient, view_by_read_class: dict[type[DomainModelCore], dm.ViewId]):
        ...
        self.production_obligation_time_series = WatercourseProductionObligationTimeSeriesAPI(client, view_id)
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new watercourse:
                ...
                >>> from cognite.powerops.client._generated.production.data_classes import WatercourseApply
        ...
        """
        return self._apply(watercourse, replace)
