...
from cognite.powerops.client._generated.afrr_bid.data_classes._bid_method import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new bid_method:
                ...
                >>> from cognite.powerops.client._generated.afrr_bid.data_classes import BidMethodWrite
                >>> client = AFRRBidAPI()
