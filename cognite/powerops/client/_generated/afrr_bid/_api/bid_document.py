...
class BidDocumentAPI(NodeAPI[BidDocument, BidDocumentWrite, BidDocumentList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new bid_document:
                ...
                >>> from cognite.powerops.client._generated.afrr_bid.data_classes import BidDocumentWrite
                >>> client = AFRRBidAPI()
        ...
        return self._retrieve(
            ...
            edge_api_name_type_direction_view_id_penta=[
                ...
                (
                    ...
                    "outwards",
                    dm.ViewId("power-ops-afrr-bid", "BidRow", "1"),
                ),
            ],
        )
    ...
    def list(
        ...
        Args:
            ...
            limit: Maximum number of bid documents to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
            filter: (Advanced) If the filtering available in the above is not sufficient, you can write your own filtering which will be ANDed with the filter above.
            retrieve_edges: Whether to retrieve `alerts` or `bids` external ids for the bid documents. Defaults to True.
