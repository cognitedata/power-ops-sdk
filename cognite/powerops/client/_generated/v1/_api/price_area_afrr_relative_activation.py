...
class PriceAreaAFRRRelativeActivationQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_afrr.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::
                ...
                >>> price_area_afrr_datapoints = client.price_area_afrr.relative_activation(external_id="my_relative_activation").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_afrr.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.relative_activation(external_id="my_relative_activation").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_afrr.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.relative_activation(external_id="my_relative_activation").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_afrr.relative_activation` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_relative_activation' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.relative_activation(
...
class PriceAreaAFRRRelativeActivationAPI:
    ...
    def __call__(
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_afrr.relative_activation timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_afrr.relative_activation timeseries:
        ...
        return PriceAreaAFRRRelativeActivationQuery(
            client=self._client,
    ...
    def list(
        ...
        Returns:
            List of Timeseries price_area_afrr.relative_activation.

        Examples:

            List price_area_afrr.relative_activation and limit to 5:
