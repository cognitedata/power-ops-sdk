...
from cognite.powerops.client._generated.v1.data_classes._watercourse import _create_watercourse_filter
from ._core import DEFAULT_LIMIT_READ, INSTANCE_QUERY_LIMIT

ColumnNames = Literal["name", "displayName", "ordering", "productionObligation", "penaltyLimit"]
...
class WatercourseProductionObligationQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `watercourse.production_obligation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_production_obligation' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> watercourse_datapoints = client.watercourse.production_obligation(external_id="my_production_obligation").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `watercourse.production_obligation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_obligation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> watercourse_datapoints = client.watercourse.production_obligation(external_id="my_production_obligation").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "productionObligation",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `watercourse.production_obligation` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to productionObligation
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_obligation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> watercourse_datapoints = client.watercourse.production_obligation(external_id="my_production_obligation").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `watercourse.production_obligation` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_production_obligation' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> from datetime import datetime, timezone
                >>> client = PowerOpsModelsV1Client()
                >>> watercourse_datapoints = client.watercourse.production_obligation(
                ...     external_id="my_production_obligation").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "productionObligation"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_production_obligation(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "productionObligation":
            return df
...
class WatercourseProductionObligationAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> WatercourseProductionObligationQuery:
        """Query timeseries `watercourse.production_obligation`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the watercourse.production_obligation timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 watercourse.production_obligation timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> watercourses = client.watercourse.production_obligation(limit=5).retrieve()
        ...
        return WatercourseProductionObligationQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `watercourse.production_obligation`
        ...
        Returns:
            List of Timeseries watercourse.production_obligation.

        Examples:

            List watercourse.production_obligation and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> watercourses = client.watercourse.production_obligation.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_production_obligation(
...
def _retrieve_timeseries_external_ids_with_extra_production_obligation(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "productionObligation",
) -> dict[str, list[str]]:
    limit = float("inf") if limit is None or limit == -1 else limit
    properties = ["productionObligation"]
    if extra_properties == "productionObligation":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "productionObligation":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "productionObligation"])
    else:
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("productionObligation"))
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["productionObligation"]: [
