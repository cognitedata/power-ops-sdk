...
from cognite.powerops.client._generated.v1._api.benchmarking_configuration_day_ahead import (
    BenchmarkingConfigurationDayAheadAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_configuration_day_ahead_assets_per_shop_model import (
    BenchmarkingConfigurationDayAheadAssetsPerShopModelAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_configuration_day_ahead_bid_configurations import (
    BenchmarkingConfigurationDayAheadBidConfigurationsAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_production_obligation_day_ahead import (
...
from cognite.powerops.client._generated.v1._api.benchmarking_result_day_ahead_alerts import (
...
from cognite.powerops.client._generated.v1._api.benchmarking_task_dispatcher_input_day_ahead import (
    BenchmarkingTaskDispatcherInputDayAheadAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_task_dispatcher_output_day_ahead import (
    BenchmarkingTaskDispatcherOutputDayAheadAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_task_dispatcher_output_day_ahead_alerts import (
    BenchmarkingTaskDispatcherOutputDayAheadAlertsAPI,
)
from cognite.powerops.client._generated.v1._api.benchmarking_task_dispatcher_output_day_ahead_benchmarking_sub_tasks import (
...
from cognite.powerops.client._generated.v1._api.bid_configuration_day_ahead_partials import (
...
from cognite.powerops.client._generated.v1._api.generator_turbine_efficiency_curves import (
...
from cognite.powerops.client._generated.v1._api.multi_scenario_partial_bid_matrix_calculation_input import (
    MultiScenarioPartialBidMatrixCalculationInputAPI,
)
from cognite.powerops.client._generated.v1._api.multi_scenario_partial_bid_matrix_calculation_input_price_production import (
...
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_calculation_input import (
    PartialBidMatrixCalculationInputAPI,
)
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_calculation_output import (
    PartialBidMatrixCalculationOutputAPI,
)
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_calculation_output_alerts import (
...
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_information_with_scenarios import (
    PartialBidMatrixInformationWithScenariosAPI,
)
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_information_with_scenarios_alerts import (
    PartialBidMatrixInformationWithScenariosAlertsAPI,
)
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_information_with_scenarios_multi_scenario_input import (
    PartialBidMatrixInformationWithScenariosMultiScenarioInputAPI,
)
from cognite.powerops.client._generated.v1._api.partial_bid_matrix_information_with_scenarios_underlying_bid_matrices import (
...
from cognite.powerops.client._generated.v1._api.shop_based_partial_bid_configuration import (
...
from cognite.powerops.client._generated.v1._api.shop_model_with_assets_power_assets import (
    ShopModelWithAssetsPowerAssetsAPI,
)
from cognite.powerops.client._generated.v1._api.shop_model_with_assets_production_obligations import (
    ShopModelWithAssetsProductionObligationsAPI,
)
from cognite.powerops.client._generated.v1._api.shop_output_time_series_definition import (
...
from cognite.powerops.client._generated.v1._api.shop_scenario_attribute_mappings_override import (
...
from cognite.powerops.client._generated.v1._api.task_dispatcher_output_process_sub_tasks import (
    TaskDispatcherOutputProcessSubTasksAPI,
)
from cognite.powerops.client._generated.v1._api.total_bid_matrix_calculation_input import (
    TotalBidMatrixCalculationInputAPI,
)
from cognite.powerops.client._generated.v1._api.total_bid_matrix_calculation_input_partial_bid_matrices import (
    TotalBidMatrixCalculationInputPartialBidMatricesAPI,
)
from cognite.powerops.client._generated.v1._api.total_bid_matrix_calculation_output import (
...
from cognite.powerops.client._generated.v1._api.water_value_based_partial_bid_configuration import (
    WaterValueBasedPartialBidConfigurationAPI,
)
from cognite.powerops.client._generated.v1._api.water_value_based_partial_bid_matrix_calculation_input import (
