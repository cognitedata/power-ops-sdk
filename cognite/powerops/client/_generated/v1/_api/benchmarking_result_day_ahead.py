...
class BenchmarkingResultDayAheadAPI(
    NodeAPI[BenchmarkingResultDayAhead, BenchmarkingResultDayAheadWrite, BenchmarkingResultDayAheadList]
):
    def __init__(self, client: CogniteClient, view_by_read_class: dict[type[DomainModelCore], dm.ViewId]):
        view_id = view_by_read_class[BenchmarkingResultDayAhead]
        super().__init__(
            client=client,
            sources=view_id,
            class_type=BenchmarkingResultDayAhead,
            class_list=BenchmarkingResultDayAheadList,
            class_write_list=BenchmarkingResultDayAheadWriteList,
    ...
    def __call__(
        ...
        return BenchmarkingResultDayAheadQueryAPI(self._client, builder, self._view_by_read_class, filter_, limit)
    ...
    def search(
        self,
        query: str,
        properties: BenchmarkingResultDayAheadTextFields | Sequence[BenchmarkingResultDayAheadTextFields] | None = None,
        name: str | list[str] | None = None,
        name_prefix: str | None = None,
        workflow_execution_id: str | list[str] | None = None,
        workflow_execution_id_prefix: str | None = None,
        ...
        return self._search(
            self._view_id, query, _BENCHMARKINGRESULTDAYAHEAD_PROPERTIES_BY_FIELD, properties, filter_, limit
        )
    ...
    def aggregate(
        ...
        property: BenchmarkingResultDayAheadFields | Sequence[BenchmarkingResultDayAheadFields] | None = None,
        group_by: None = None,
        query: str | None = None,
        search_properties: (
            BenchmarkingResultDayAheadTextFields | Sequence[BenchmarkingResultDayAheadTextFields] | None
        ) = None,
        name: str | list[str] | None = None,
        name_prefix: str | None = None,
        workflow_execution_id: str | list[str] | None = None,
    ...
    def aggregate(
        ...
        property: BenchmarkingResultDayAheadFields | Sequence[BenchmarkingResultDayAheadFields] | None = None,
        group_by: BenchmarkingResultDayAheadFields | Sequence[BenchmarkingResultDayAheadFields] = None,
        query: str | None = None,
        search_properties: (
            BenchmarkingResultDayAheadTextFields | Sequence[BenchmarkingResultDayAheadTextFields] | None
        ) = None,
    ...
    def aggregate(
        ...
        property: BenchmarkingResultDayAheadFields | Sequence[BenchmarkingResultDayAheadFields] | None = None,
        group_by: BenchmarkingResultDayAheadFields | Sequence[BenchmarkingResultDayAheadFields] | None = None,
        query: str | None = None,
        search_property: (
            BenchmarkingResultDayAheadTextFields | Sequence[BenchmarkingResultDayAheadTextFields] | None
        ) = None,
    ...
    def list(
        ...
        return self._list(
            limit=limit,
            filter=filter_,
            properties_by_field=_BENCHMARKINGRESULTDAYAHEAD_PROPERTIES_BY_FIELD,
            sort_by=sort_by,
            direction=direction,
