...
class PartialBidMatrixInformationLinkedTimeSeriesAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the partial_bid_matrix_information.linked_time_series timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 partial_bid_matrix_information.linked_time_series timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> partial_bid_matrix_information_list = client.partial_bid_matrix_information.linked_time_series(
                ...     limit=5
                ... ).retrieve()
