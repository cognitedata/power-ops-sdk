...
class TotalBidMatrixCalculationOutputQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def alerts(
        ...
        Args:
            ...
            retrieve_function_input: Whether to retrieve the function input
                for each total bid matrix calculation output or not.
            retrieve_bid_document: Whether to retrieve the bid document
                for each total bid matrix calculation output or not.
    ...
    def query(
        ...
        Args:
            retrieve_function_input: Whether to retrieve the
                ...
                total bid matrix calculation output or not.
            retrieve_bid_document: Whether to retrieve the
                bid document for each
                total bid matrix calculation output or not.
    ...
    def _query_append_function_input(self, from_: str) -> None:
        self._builder.append(
            QueryStep(
                ...
                view_id=TotalBidMatrixCalculationInput._view_id,
    ...
    def _query_append_bid_document(self, from_: str) -> None:
        self._builder.append(
            QueryStep(
                ...
                view_id=BidDocumentDayAhead._view_id,
