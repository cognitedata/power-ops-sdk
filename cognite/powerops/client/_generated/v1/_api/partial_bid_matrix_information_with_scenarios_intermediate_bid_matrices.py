...
class PartialBidMatrixInformationWithScenariosIntermediateBidMatricesAPI(EdgeAPI):
    def list(
        self,
        ...
        """List intermediate bid matrice edges of a partial bid matrix information with scenario.
        ...
        Examples:
            ...
            List 5 intermediate bid matrice edges connected to "my_partial_bid_matrix_information_with_scenario":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> partial_bid_matrix_information_with_scenario = client.partial_bid_matrix_information_with_scenarios.intermediate_bid_matrices_edge.list("my_partial_bid_matrix_information_with_scenario", limit=5)
