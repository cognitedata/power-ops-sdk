...
class SHOPResultOutputTimeseriesAPI(EdgeAPI):
    def list(
        ...
        """List output timesery edges of a shop result.
        ...
        Returns:
            The requested output timesery edges.

        Examples:

            List 5 output timesery edges connected to "my_shop_result":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result = client.shop_result.output_timeseries_edge.list("my_shop_result", limit=5)
