...
class CaseShopFilesAPI(EdgeAPI):
    def list(
        self,
        from_case: str | list[str] | dm.NodeId | list[dm.NodeId] | None = None,
        from_case_space: str = DEFAULT_INSTANCE_SPACE,
        ...
        """List shop file edges of a case.

        Args:
            from_case: ID of the source case.
            from_case_space: Location of the cases.
        ...
        Examples:
            ...
            List 5 shop file edges connected to "my_case":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> case = client.case.shop_files_edge.list("my_case", limit=5)
