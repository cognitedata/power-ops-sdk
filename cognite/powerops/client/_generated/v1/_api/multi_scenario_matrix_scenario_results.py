...
class MultiScenarioMatrixScenarioResultsAPI(EdgeAPI):
    def list(
        ...
        to_price_prod_case: str | list[str] | dm.NodeId | list[dm.NodeId] | None = None,
        to_price_prod_case_space: str = DEFAULT_INSTANCE_SPACE,
        ...
        Args:
            ...
            to_price_prod_case: ID of the target price prod case.
            to_price_prod_case_space: Location of the price prod cases.
