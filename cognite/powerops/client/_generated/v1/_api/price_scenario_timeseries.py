...
class PriceScenarioTimeseriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_scenario.timeseries` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_timeseries' from 2 weeks ago up until now::
                ...
                >>> price_scenario_datapoints = client.price_scenario.timeseries(external_id="my_timeseries").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_scenario.timeseries` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_timeseries' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_scenario_datapoints = client.price_scenario.timeseries(external_id="my_timeseries").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_scenario.timeseries` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_timeseries' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_scenario_datapoints = client.price_scenario.timeseries(external_id="my_timeseries").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_scenario.timeseries` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_timeseries' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_scenario_datapoints = client.price_scenario.timeseries(
...
class PriceScenarioTimeseriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceScenarioTimeseriesQuery:
        """Query timeseries `price_scenario.timeseries`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_scenario.timeseries timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_scenario.timeseries timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_scenarios = client.price_scenario.timeseries(limit=5).retrieve()
        ...
        return PriceScenarioTimeseriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_scenario.timeseries`
        ...
        Returns:
            List of Timeseries price_scenario.timeseries.

        Examples:

            List price_scenario.timeseries and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_scenarios = client.price_scenario.timeseries.list(limit=5)
