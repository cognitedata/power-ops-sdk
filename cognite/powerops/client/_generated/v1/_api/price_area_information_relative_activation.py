...
class PriceAreaInformationRelativeActivationQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.relative_activation(external_id="my_relative_activation").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.relative_activation(external_id="my_relative_activation").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "relativeActivation",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `price_area_information.relative_activation` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to relativeActivation
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_relative_activation' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.relative_activation(external_id="my_relative_activation").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.relative_activation` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_relative_activation' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> from datetime import datetime, timezone
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.relative_activation(
                ...     external_id="my_relative_activation").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "relativeActivation"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_relative_activation(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "relativeActivation":
            return df
...
class PriceAreaInformationRelativeActivationAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationRelativeActivationQuery:
        """Query timeseries `price_area_information.relative_activation`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.relative_activation timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.relative_activation timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.relative_activation(limit=5).retrieve()
        ...
        return PriceAreaInformationRelativeActivationQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.relative_activation`
        ...
        Returns:
            List of Timeseries price_area_information.relative_activation.

        Examples:

            List price_area_information.relative_activation and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.relative_activation.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_relative_activation(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_relative_activation(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "relativeActivation",
) -> dict[str, list[str]]:
    limit_input = float("inf") if limit is None or limit == -1 else limit
    properties = ["relativeActivation"]
    if extra_properties == "relativeActivation":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "relativeActivation":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "relativeActivation"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["relativeActivation"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
