...
class BenchmarkingCalculationOutputAPI(
    NodeAPI[BenchmarkingCalculationOutput, BenchmarkingCalculationOutputWrite, BenchmarkingCalculationOutputList]
):
    def __init__(self, client: CogniteClient, view_by_read_class: dict[type[DomainModelCore], dm.ViewId]):
        view_id = view_by_read_class[BenchmarkingCalculationOutput]
        super().__init__(
            client=client,
            sources=view_id,
            class_type=BenchmarkingCalculationOutput,
            class_list=BenchmarkingCalculationOutputList,
            class_write_list=BenchmarkingCalculationOutputWriteList,
    ...
    def __call__(
        ...
        return BenchmarkingCalculationOutputQueryAPI(self._client, builder, self._view_by_read_class, filter_, limit)

    def apply(
        self,
        benchmarking_calculation_output: (
            BenchmarkingCalculationOutputWrite | Sequence[BenchmarkingCalculationOutputWrite]
        ),
        replace: bool = False,
    ...
    def search(
        ...
        query: str,
        properties: (
            BenchmarkingCalculationOutputTextFields | Sequence[BenchmarkingCalculationOutputTextFields] | None
        ) = None,
        workflow_execution_id: str | list[str] | None = None,
        workflow_execution_id_prefix: str | None = None,
        min_workflow_step: int | None = None,
        ...
        return self._search(
            self._view_id, query, _BENCHMARKINGCALCULATIONOUTPUT_PROPERTIES_BY_FIELD, properties, filter_, limit
        )
    ...
    def aggregate(
        ...
        property: BenchmarkingCalculationOutputFields | Sequence[BenchmarkingCalculationOutputFields] | None = None,
        group_by: None = None,
        query: str | None = None,
        search_properties: (
            BenchmarkingCalculationOutputTextFields | Sequence[BenchmarkingCalculationOutputTextFields] | None
    ...
    def aggregate(
        ...
        property: BenchmarkingCalculationOutputFields | Sequence[BenchmarkingCalculationOutputFields] | None = None,
        group_by: BenchmarkingCalculationOutputFields | Sequence[BenchmarkingCalculationOutputFields] = None,
        query: str | None = None,
        search_properties: (
            BenchmarkingCalculationOutputTextFields | Sequence[BenchmarkingCalculationOutputTextFields] | None
        ) = None,
    ...
    def aggregate(
        ...
        property: BenchmarkingCalculationOutputFields | Sequence[BenchmarkingCalculationOutputFields] | None = None,
        group_by: BenchmarkingCalculationOutputFields | Sequence[BenchmarkingCalculationOutputFields] | None = None,
        query: str | None = None,
        search_property: (
            BenchmarkingCalculationOutputTextFields | Sequence[BenchmarkingCalculationOutputTextFields] | None
        ) = None,
    ...
    def list(
        ...
        return self._list(
            limit=limit,
            filter=filter_,
            properties_by_field=_BENCHMARKINGCALCULATIONOUTPUT_PROPERTIES_BY_FIELD,
            sort_by=sort_by,
            direction=direction,
