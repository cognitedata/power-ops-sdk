...
from cognite.powerops.client._generated.v1.data_classes._custom_bid_matrix import (
...
class CustomBidMatrixAPI(NodeAPI[CustomBidMatrix, CustomBidMatrixWrite, CustomBidMatrixList]):
    def __init__(self, client: CogniteClient, view_by_read_class: dict[type[DomainModelCore], dm.ViewId]):
        ...
        super().__init__(
            ...
            class_write_list=CustomBidMatrixWriteList,
    ...
    def apply(
        self,
        custom_bid_matrix: CustomBidMatrixWrite | Sequence[CustomBidMatrixWrite],
        replace: bool = False,
        ...
        Examples:
            ...
            Create a new custom_bid_matrix:
                ...
                >>> from cognite.powerops.client._generated.v1.data_classes import CustomBidMatrixWrite
                >>> client = PowerOpsModelsV1Client()
                >>> custom_bid_matrix = CustomBidMatrixWrite(external_id="my_custom_bid_matrix", ...)
        ...
        warnings.warn(
            ...
            "`my_client.custom_bid_matrix.apply(my_items)` please use `my_client.upsert(my_items)`."
    ...
    def delete(
        ...
        warnings.warn(
            ...
            "`my_client.custom_bid_matrix.delete(my_ids)` please use `my_client.delete(my_ids)`."
