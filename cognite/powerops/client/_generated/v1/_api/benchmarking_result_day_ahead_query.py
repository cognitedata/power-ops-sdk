...
class BenchmarkingResultDayAheadQueryAPI(QueryAPI[T_DomainModelList]):
    def __init__(
        self,
        ...
        self._builder.append(
            QueryStep(
                name=self._builder.next_name("benchmarking_result_day_ahead"),
                expression=dm.query.NodeResultSetExpression(
                    from_=self._builder[-1].name if self._builder else None,
                    filter=filter_,
                ),
                select=dm.query.Select(
                    [dm.query.SourceSelector(self._view_by_read_class[BenchmarkingResultDayAhead], ["*"])]
                ),
                result_cls=BenchmarkingResultDayAhead,
    ...
    def alerts(
        ...
        """Query along the alert edges of the benchmarking result day ahead.
        ...
        Args:
            ...
            limit: Maximum number of alert edges to return. Defaults to 3. Set to -1, float("inf") or None
                to return all items.
            retrieve_shop_result: Whether to retrieve the shop result for each benchmarking result day ahead or not.
        ...
        self._builder.append(
            QueryStep(
                ...
                expression=dm.query.NodeResultSetExpression(
                    ...
                    from_=from_,
                    through=self._view_by_read_class[BenchmarkingResultDayAhead].as_property_ref("shopResult"),
                    direction="outwards",
                ),
