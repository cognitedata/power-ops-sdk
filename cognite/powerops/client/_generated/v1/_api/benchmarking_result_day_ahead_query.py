...
class BenchmarkingResultDayAheadQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def alerts(
        ...
        Args:
            ...
            retrieve_shop_result: Whether to retrieve the shop result
                for each benchmarking result day ahead or not.
    ...
    def query(
        ...
        Args:
            retrieve_shop_result: Whether to retrieve the
                ...
                benchmarking result day ahead or not.
