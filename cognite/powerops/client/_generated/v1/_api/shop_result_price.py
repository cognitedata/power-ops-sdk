...
class SHOPResultPriceQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_result.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> shop_result_datapoints = client.shop_result.price(external_id="my_price").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_result.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.price(external_id="my_price").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_result.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.price(external_id="my_price").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_result.price` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_price' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.price(
...
class SHOPResultPriceAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> SHOPResultPriceQuery:
        """Query timeseries `shop_result.price`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_result.price timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_result.price timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_results = client.shop_result.price(limit=5).retrieve()
    ...
    def list(
        ...
        """List timeseries `shop_result.price`
        ...
        Returns:
            List of Timeseries shop_result.price.

        Examples:

            List shop_result.price and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_results = client.shop_result.price.list(limit=5)
