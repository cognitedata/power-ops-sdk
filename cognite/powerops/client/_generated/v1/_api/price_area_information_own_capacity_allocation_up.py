...
class PriceAreaInformationOwnCapacityAllocationUpQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.own_capacity_allocation_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_up' from 2 weeks ago up until now::
                ...
                >>> price_area_information_datapoints = client.price_area_information.own_capacity_allocation_up(external_id="my_own_capacity_allocation_up").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.own_capacity_allocation_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_up' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.own_capacity_allocation_up(external_id="my_own_capacity_allocation_up").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_information.own_capacity_allocation_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_up' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.own_capacity_allocation_up(external_id="my_own_capacity_allocation_up").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.own_capacity_allocation_up` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_own_capacity_allocation_up' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.own_capacity_allocation_up(
...
class PriceAreaInformationOwnCapacityAllocationUpAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationOwnCapacityAllocationUpQuery:
        """Query timeseries `price_area_information.own_capacity_allocation_up`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.own_capacity_allocation_up timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.own_capacity_allocation_up timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.own_capacity_allocation_up(limit=5).retrieve()
        ...
        return PriceAreaInformationOwnCapacityAllocationUpQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.own_capacity_allocation_up`
        ...
        Returns:
            List of Timeseries price_area_information.own_capacity_allocation_up.

        Examples:

            List price_area_information.own_capacity_allocation_up and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.own_capacity_allocation_up.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_own_capacity_allocation_up(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_own_capacity_allocation_up(
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["ownCapacityAllocationUp"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
