    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_main_price_scenario'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_main_price_scenario' for the
...
class PriceAreaDayAheadMainPriceScenarioAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the price_area_day_ahead.main_price_scenario timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 price_area_day_ahead.main_price_scenario timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_aheads = client.price_area_day_ahead.main_price_scenario(
                ...     limit=5
                ... ).retrieve()
