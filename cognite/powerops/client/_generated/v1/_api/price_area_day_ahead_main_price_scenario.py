...
from cognite.powerops.client._generated.v1.data_classes._price_area_day_ahead import _create_price_area_day_ahead_filter
from ._core import DEFAULT_LIMIT_READ, INSTANCE_QUERY_LIMIT

ColumnNames = Literal["name", "displayName", "ordering", "assetType", "mainPriceScenario", "priceScenarios"]

class PriceAreaDayAheadMainPriceScenarioQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_day_ahead.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_ahead_datapoints = client.price_area_day_ahead.main_price_scenario(external_id="my_main_price_scenario").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_day_ahead.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_ahead_datapoints = client.price_area_day_ahead.main_price_scenario(external_id="my_main_price_scenario").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "mainPriceScenario",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `price_area_day_ahead.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to mainPriceScenario
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_ahead_datapoints = client.price_area_day_ahead.main_price_scenario(external_id="my_main_price_scenario").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_day_ahead.main_price_scenario` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_main_price_scenario' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> from datetime import datetime, timezone
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_ahead_datapoints = client.price_area_day_ahead.main_price_scenario(
                ...     external_id="my_main_price_scenario").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "mainPriceScenario"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_main_price_scenario(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "mainPriceScenario":
            return df
...
class PriceAreaDayAheadMainPriceScenarioAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaDayAheadMainPriceScenarioQuery:
        """Query timeseries `price_area_day_ahead.main_price_scenario`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_day_ahead.main_price_scenario timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_day_ahead.main_price_scenario timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_aheads = client.price_area_day_ahead.main_price_scenario(limit=5).retrieve()
        ...
        return PriceAreaDayAheadMainPriceScenarioQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_day_ahead.main_price_scenario`
        ...
        Returns:
            List of Timeseries price_area_day_ahead.main_price_scenario.

        Examples:

            List price_area_day_ahead.main_price_scenario and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_day_aheads = client.price_area_day_ahead.main_price_scenario.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_main_price_scenario(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_main_price_scenario(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "mainPriceScenario",
) -> dict[str, list[str]]:
    limit_input = float("inf") if limit is None or limit == -1 else limit
    properties = ["mainPriceScenario"]
    if extra_properties == "mainPriceScenario":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "mainPriceScenario":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "mainPriceScenario"])
    else:
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("mainPriceScenario"))
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["mainPriceScenario"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
