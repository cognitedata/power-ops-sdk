    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_production'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_production' for the
...
class PriceProductionProductionAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the price_production.production timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 price_production.production timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_productions = client.price_production.production(
                ...     limit=5
                ... ).retrieve()
