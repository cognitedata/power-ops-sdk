...
class PriceProdCaseProductionQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_prod_case.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> price_prod_case_datapoints = client.price_prod_case.production(external_id="my_production").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_prod_case.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_prod_case_datapoints = client.price_prod_case.production(external_id="my_production").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_prod_case.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_prod_case_datapoints = client.price_prod_case.production(external_id="my_production").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_prod_case.production` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_production' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_prod_case_datapoints = client.price_prod_case.production(
...
class PriceProdCaseProductionAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceProdCaseProductionQuery:
        """Query timeseries `price_prod_case.production`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_prod_case.production timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_prod_case.production timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_prod_cases = client.price_prod_case.production(limit=5).retrieve()
        ...
        return PriceProdCaseProductionQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_prod_case.production`
        ...
        Returns:
            List of Timeseries price_prod_case.production.

        Examples:

            List price_prod_case.production and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_prod_cases = client.price_prod_case.production.list(limit=5)
