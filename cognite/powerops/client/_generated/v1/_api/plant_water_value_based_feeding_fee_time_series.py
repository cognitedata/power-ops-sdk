...
class PlantWaterValueBasedFeedingFeeTimeSeriesQuery:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `plant_water_value_based.feeding_fee_time_series` timeseries.
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `plant_water_value_based.feeding_fee_time_series` timeseries in Timezone.
...
class PlantWaterValueBasedFeedingFeeTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PlantWaterValueBasedFeedingFeeTimeSeriesQuery:
        """Query timeseries `plant_water_value_based.feeding_fee_time_series`
        ...
        Examples:
            ...
            Retrieve all data for 5 plant_water_value_based.feeding_fee_time_series timeseries:
        ...
        return PlantWaterValueBasedFeedingFeeTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `plant_water_value_based.feeding_fee_time_series`
        ...
        Examples:
            ...
            List plant_water_value_based.feeding_fee_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_baseds = client.plant_water_value_based.feeding_fee_time_series.list(limit=5)
