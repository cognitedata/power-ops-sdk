...
class ShopPartialBidCalculationInputAlertsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List alert edges of a shop partial bid calculation input.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_shop_partial_bid_calculation_input":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_partial_bid_calculation_input = client.shop_partial_bid_calculation_input.alerts_edge.list("my_shop_partial_bid_calculation_input", limit=5)
