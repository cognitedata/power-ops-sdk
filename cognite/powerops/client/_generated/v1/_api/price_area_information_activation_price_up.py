...
class PriceAreaInformationActivationPriceUpQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.activation_price_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_up' from 2 weeks ago up until now::
                ...
                >>> price_area_information_datapoints = client.price_area_information.activation_price_up(external_id="my_activation_price_up").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.activation_price_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_up' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_up(external_id="my_activation_price_up").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_information.activation_price_up` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_up' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_up(external_id="my_activation_price_up").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.activation_price_up` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_activation_price_up' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_up(
...
class PriceAreaInformationActivationPriceUpAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationActivationPriceUpQuery:
        """Query timeseries `price_area_information.activation_price_up`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.activation_price_up timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.activation_price_up timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.activation_price_up(limit=5).retrieve()
        ...
        return PriceAreaInformationActivationPriceUpQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.activation_price_up`
        ...
        Returns:
            List of Timeseries price_area_information.activation_price_up.

        Examples:

            List price_area_information.activation_price_up and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.activation_price_up.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_activation_price_up(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_activation_price_up(
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["activationPriceUp"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
