...
class BidMatrixInformationIntermediateBidMatricesAPI(EdgeAPI):
    def list(
        self,
        ...
        """List intermediate bid matrice edges of a bid matrix information.
        ...
        Examples:
            ...
            List 5 intermediate bid matrice edges connected to "my_bid_matrix_information":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> bid_matrix_information = client.bid_matrix_information.intermediate_bid_matrices_edge.list("my_bid_matrix_information", limit=5)
