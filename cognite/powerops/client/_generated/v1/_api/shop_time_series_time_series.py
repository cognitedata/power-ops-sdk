...
class ShopTimeSeriesTimeSeriesQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_time_series.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> shop_time_series_datapoints = client.shop_time_series.time_series(external_id="my_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_time_series.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_time_series_datapoints = client.shop_time_series.time_series(external_id="my_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_time_series.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_time_series_datapoints = client.shop_time_series.time_series(external_id="my_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_time_series.time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_time_series' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> shop_time_series_datapoints = client.shop_time_series.time_series(
...
class ShopTimeSeriesTimeSeriesAPI:
    ...
    def __call__(
        ...
        """Query timeseries `shop_time_series.time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_time_series.time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_time_series.time_series timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_time_series_list = client.shop_time_series.time_series(limit=5).retrieve()
    ...
    def list(
        ...
        """List timeseries `shop_time_series.time_series`
        ...
        Returns:
            List of Timeseries shop_time_series.time_series.

        Examples:

            List shop_time_series.time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_time_series_list = client.shop_time_series.time_series.list(limit=5)
