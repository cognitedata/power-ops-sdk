...
class BidDocumentDayAheadQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def alerts(
        ...
        Args:
            ...
            retrieve_bid_configuration: Whether to retrieve the bid configuration
                for each bid document day ahead or not.
            retrieve_total: Whether to retrieve the total
                for each bid document day ahead or not.
    ...
    def partials(
        ...
        retrieve_bid_configuration: bool = False,
        retrieve_total: bool = False,
    ) -> PartialBidMatrixInformationQueryAPI[T_DomainModel, T_DomainModelList]:
        ...
        has_data = dm.filters.HasData(views=[view_id])
        node_filter = _create_partial_bid_matrix_information_filter(
            view_id,
            state,
            state_prefix,
            power_asset,
    ...
    def query(
        ...
        Args:
            retrieve_bid_configuration: Whether to retrieve the
                ...
                bid document day ahead or not.
            retrieve_total: Whether to retrieve the
                total for each
                bid document day ahead or not.
