...
class TotalBidMatrixCalculationInputQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def partial_bid_matrices(
        ...
        Args:
            ...
            limit: Maximum number of partial bid matrice edges to return.
            ...
            retrieve_bid_configuration: Whether to retrieve the bid configuration
                for each total bid matrix calculation input or not.
    ...
    def query(
        ...
        Args:
            retrieve_bid_configuration: Whether to retrieve the
                ...
                total bid matrix calculation input or not.
