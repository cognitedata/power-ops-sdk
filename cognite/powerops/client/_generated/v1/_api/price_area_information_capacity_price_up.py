    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_capacity_price_up'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_capacity_price_up' for the
...
class PriceAreaInformationCapacityPriceUpAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the price_area_information.capacity_price_up timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 price_area_information.capacity_price_up timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.capacity_price_up(
                ...     limit=5
                ... ).retrieve()
