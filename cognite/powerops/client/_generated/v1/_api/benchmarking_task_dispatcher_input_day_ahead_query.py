...
class BenchmarkingTaskDispatcherInputDayAheadQueryAPI(QueryAPI[T_DomainModelList]):
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select(
                    [dm.query.SourceSelector(self._view_by_read_class[BenchmarkingTaskDispatcherInputDayAhead], ["*"])]
                ),
    ...
    def _query_append_benchmarking_config(self, from_: str) -> None:
        view_id = self._view_by_read_class[BenchmarkingConfigurationDayAhead]
        self._builder.append(
            QueryStep(
                ...
                expression=dm.query.NodeResultSetExpression(
                    ...
                    from_=from_,
                    through=self._view_by_read_class[BenchmarkingTaskDispatcherInputDayAhead].as_property_ref(
                        "benchmarkingConfig"
                    ),
                    direction="outwards",
                ),
