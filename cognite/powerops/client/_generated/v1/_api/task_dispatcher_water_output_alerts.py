...
class TaskDispatcherWaterOutputAlertsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List alert edges of a task dispatcher water output.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_task_dispatcher_water_output":

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> task_dispatcher_water_output = client.task_dispatcher_water_output.alerts_edge.list("my_task_dispatcher_water_output", limit=5)
