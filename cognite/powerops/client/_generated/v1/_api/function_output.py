...
class FunctionOutputAPI(NodeAPI[FunctionOutput, FunctionOutputWrite, FunctionOutputList, FunctionOutputWriteList]):
    ...
    ) -> FunctionOutputQueryAPI[FunctionOutput, FunctionOutputList]:
    ...
    def apply(
        ...
        Args:
            function_output: Function output or
                sequence of function outputs to upsert.
        ...
        Examples:
            ...
            Create a new function_output:
                ...
                >>> function_output = FunctionOutputWrite(
                ...     external_id="my_function_output", ...
                ... )
