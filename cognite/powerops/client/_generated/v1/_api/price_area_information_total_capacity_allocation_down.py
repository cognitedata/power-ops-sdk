...
class PriceAreaInformationTotalCapacityAllocationDownQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.total_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_total_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> price_area_information_datapoints = client.price_area_information.total_capacity_allocation_down(external_id="my_total_capacity_allocation_down").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.total_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_total_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.total_capacity_allocation_down(external_id="my_total_capacity_allocation_down").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_information.total_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_total_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.total_capacity_allocation_down(external_id="my_total_capacity_allocation_down").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.total_capacity_allocation_down` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_total_capacity_allocation_down' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.total_capacity_allocation_down(
...
class PriceAreaInformationTotalCapacityAllocationDownAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationTotalCapacityAllocationDownQuery:
        """Query timeseries `price_area_information.total_capacity_allocation_down`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.total_capacity_allocation_down timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.total_capacity_allocation_down timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.total_capacity_allocation_down(limit=5).retrieve()
        ...
        return PriceAreaInformationTotalCapacityAllocationDownQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.total_capacity_allocation_down`
        ...
        Returns:
            List of Timeseries price_area_information.total_capacity_allocation_down.

        Examples:

            List price_area_information.total_capacity_allocation_down and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.total_capacity_allocation_down.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_total_capacity_allocation_down(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_total_capacity_allocation_down(
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("totalCapacityAllocationDown"))
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["totalCapacityAllocationDown"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
