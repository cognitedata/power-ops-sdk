    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_head_direct_time_series'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_head_direct_time_series' for the
...
class PlantInformationHeadDirectTimeSeriesAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the plant_information.head_direct_time_series timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 plant_information.head_direct_time_series timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_information_list = client.plant_information.head_direct_time_series(
                ...     limit=5
                ... ).retrieve()
