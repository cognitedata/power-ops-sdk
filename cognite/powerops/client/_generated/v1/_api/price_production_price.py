    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_price'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_price' for the
...
class PriceProductionPriceAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the price_production.price timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 price_production.price timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_productions = client.price_production.price(
                ...     limit=5
                ... ).retrieve()
