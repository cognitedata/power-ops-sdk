...
class PlantWaterValueBasedProductionMinTimeSeriesQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `plant_water_value_based.production_min_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_min_time_series' from 2 weeks ago up until now::
                ...
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_min_time_series(external_id="my_production_min_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `plant_water_value_based.production_min_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_min_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_min_time_series(external_id="my_production_min_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `plant_water_value_based.production_min_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_min_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_min_time_series(external_id="my_production_min_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `plant_water_value_based.production_min_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_production_min_time_series' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_min_time_series(
...
class PlantWaterValueBasedProductionMinTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PlantWaterValueBasedProductionMinTimeSeriesQuery:
        """Query timeseries `plant_water_value_based.production_min_time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the plant_water_value_based.production_min_time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 plant_water_value_based.production_min_time_series timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_baseds = client.plant_water_value_based.production_min_time_series(limit=5).retrieve()
        ...
        return PlantWaterValueBasedProductionMinTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `plant_water_value_based.production_min_time_series`
        ...
        Returns:
            List of Timeseries plant_water_value_based.production_min_time_series.

        Examples:

            List plant_water_value_based.production_min_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_baseds = client.plant_water_value_based.production_min_time_series.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_production_min_time_series(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_production_min_time_series(
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["productionMinTimeSeries"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
