...
class PriceAreaAFRROwnCapacityAllocationDownQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_afrr.own_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> price_area_afrr_datapoints = client.price_area_afrr.own_capacity_allocation_down(external_id="my_own_capacity_allocation_down").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_afrr.own_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.own_capacity_allocation_down(external_id="my_own_capacity_allocation_down").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_afrr.own_capacity_allocation_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_own_capacity_allocation_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.own_capacity_allocation_down(external_id="my_own_capacity_allocation_down").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_afrr.own_capacity_allocation_down` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_own_capacity_allocation_down' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_afrr_datapoints = client.price_area_afrr.own_capacity_allocation_down(
...
class PriceAreaAFRROwnCapacityAllocationDownAPI:
    ...
    def __call__(
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_afrr.own_capacity_allocation_down timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_afrr.own_capacity_allocation_down timeseries:
        ...
        return PriceAreaAFRROwnCapacityAllocationDownQuery(
            client=self._client,
    ...
    def list(
        ...
        Returns:
            List of Timeseries price_area_afrr.own_capacity_allocation_down.

        Examples:

            List price_area_afrr.own_capacity_allocation_down and limit to 5:
