...
class PriceAreaInformationMainPriceScenarioQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::
                ...
                >>> price_area_information_datapoints = client.price_area_information.main_price_scenario(external_id="my_main_price_scenario").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.main_price_scenario(external_id="my_main_price_scenario").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_information.main_price_scenario` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_main_price_scenario' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.main_price_scenario(external_id="my_main_price_scenario").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.main_price_scenario` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_main_price_scenario' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.main_price_scenario(
...
class PriceAreaInformationMainPriceScenarioAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationMainPriceScenarioQuery:
        """Query timeseries `price_area_information.main_price_scenario`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.main_price_scenario timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.main_price_scenario timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.main_price_scenario(limit=5).retrieve()
        ...
        return PriceAreaInformationMainPriceScenarioQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.main_price_scenario`
        ...
        Returns:
            List of Timeseries price_area_information.main_price_scenario.

        Examples:

            List price_area_information.main_price_scenario and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.main_price_scenario.list(limit=5)
