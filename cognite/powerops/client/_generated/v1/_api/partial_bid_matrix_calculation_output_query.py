...
class PartialBidMatrixCalculationOutputQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def alerts(
        ...
        Args:
            ...
            retrieve_function_input: Whether to retrieve the function input
                for each partial bid matrix calculation output or not.
            retrieve_partial_matrix: Whether to retrieve the partial matrix
                for each partial bid matrix calculation output or not.
    ...
    def query(
        ...
        Args:
            retrieve_function_input: Whether to retrieve the
                ...
                partial bid matrix calculation output or not.
            retrieve_partial_matrix: Whether to retrieve the
