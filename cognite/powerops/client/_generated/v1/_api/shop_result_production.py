...
ColumnNames = Literal["production", "price", "objectiveSequence"]


class SHOPResultProductionQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_result.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> shop_result_datapoints = client.shop_result.production(external_id="my_production").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_result.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.production(external_id="my_production").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_result.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.production(external_id="my_production").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_result.production` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_production' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> shop_result_datapoints = client.shop_result.production(
...
class SHOPResultProductionAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> SHOPResultProductionQuery:
        """Query timeseries `shop_result.production`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_result.production timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_result.production timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_results = client.shop_result.production(limit=5).retrieve()
        ...
        return SHOPResultProductionQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `shop_result.production`
        ...
        Returns:
            List of Timeseries shop_result.production.

        Examples:

            List shop_result.production and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_results = client.shop_result.production.list(limit=5)
