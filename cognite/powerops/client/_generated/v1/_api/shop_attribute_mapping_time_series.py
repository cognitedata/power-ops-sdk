...
from cognite.powerops.client._generated.v1.data_classes._shop_attribute_mapping import _create_shop_attribute_mapping_filter
from ._core import DEFAULT_LIMIT_READ, INSTANCE_QUERY_LIMIT

ColumnNames = Literal["objectType", "objectName", "attributeName", "timeSeries", "retrieve", "aggregation"]

class ShopAttributeMappingTimeSeriesQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_attribute_mapping.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> shop_attribute_mapping_datapoints = client.shop_attribute_mapping.time_series(external_id="my_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_attribute_mapping.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_attribute_mapping_datapoints = client.shop_attribute_mapping.time_series(external_id="my_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_attribute_mapping.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_attribute_mapping_datapoints = client.shop_attribute_mapping.time_series(external_id="my_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_attribute_mapping.time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_time_series' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> shop_attribute_mapping_datapoints = client.shop_attribute_mapping.time_series(
...
class ShopAttributeMappingTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> ShopAttributeMappingTimeSeriesQuery:
        """Query timeseries `shop_attribute_mapping.time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_attribute_mapping.time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_attribute_mapping.time_series timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_attribute_mappings = client.shop_attribute_mapping.time_series(limit=5).retrieve()
        ...
        return ShopAttributeMappingTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `shop_attribute_mapping.time_series`
        ...
        Returns:
            List of Timeseries shop_attribute_mapping.time_series.

        Examples:

            List shop_attribute_mapping.time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> shop_attribute_mappings = client.shop_attribute_mapping.time_series.list(limit=5)
