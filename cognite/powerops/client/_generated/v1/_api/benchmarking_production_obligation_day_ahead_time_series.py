...
from cognite.powerops.client._generated.v1.data_classes._benchmarking_production_obligation_day_ahead import _create_benchmarking_production_obligation_day_ahead_filter
from ._core import DEFAULT_LIMIT_READ, INSTANCE_QUERY_LIMIT

ColumnNames = Literal["timeSeries", "name"]

class BenchmarkingProductionObligationDayAheadTimeSeriesQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `benchmarking_production_obligation_day_ahead.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_ahead_datapoints = client.benchmarking_production_obligation_day_ahead.time_series(external_id="my_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `benchmarking_production_obligation_day_ahead.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_ahead_datapoints = client.benchmarking_production_obligation_day_ahead.time_series(external_id="my_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `benchmarking_production_obligation_day_ahead.time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_ahead_datapoints = client.benchmarking_production_obligation_day_ahead.time_series(external_id="my_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `benchmarking_production_obligation_day_ahead.time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_time_series' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> from datetime import datetime, timezone
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_ahead_datapoints = client.benchmarking_production_obligation_day_ahead.time_series(
                ...     external_id="my_time_series").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        ...
        return _retrieve_timeseries_external_ids_with_extra_time_series(
            self._client,
            self._view_id,
            self._filter,
...
class BenchmarkingProductionObligationDayAheadTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> BenchmarkingProductionObligationDayAheadTimeSeriesQuery:
        """Query timeseries `benchmarking_production_obligation_day_ahead.time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the benchmarking_production_obligation_day_ahead.time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 benchmarking_production_obligation_day_ahead.time_series timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_aheads = client.benchmarking_production_obligation_day_ahead.time_series(limit=5).retrieve()
        ...
        return BenchmarkingProductionObligationDayAheadTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `benchmarking_production_obligation_day_ahead.time_series`
        ...
        Returns:
            List of Timeseries benchmarking_production_obligation_day_ahead.time_series.

        Examples:

            List benchmarking_production_obligation_day_ahead.time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_aheads = client.benchmarking_production_obligation_day_ahead.time_series.list(limit=5)
...
def _retrieve_timeseries_external_ids_with_extra_time_series(
    client: CogniteClient,
    view_id: dm.ViewId,
