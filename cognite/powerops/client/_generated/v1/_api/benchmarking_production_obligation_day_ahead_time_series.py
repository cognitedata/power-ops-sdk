    ...
    def retrieve(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            'my_time_series' from 2 weeks ago up until now::
    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_time_series'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_time_series' for the
...
class BenchmarkingProductionObligationDayAheadTimeSeriesAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the benchmarking_production_obligation_day_ahead.time_series timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 benchmarking_production_obligation_day_ahead.time_series timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> benchmarking_production_obligation_day_aheads = client.benchmarking_production_obligation_day_ahead.time_series(
                ...     limit=5
                ... ).retrieve()
