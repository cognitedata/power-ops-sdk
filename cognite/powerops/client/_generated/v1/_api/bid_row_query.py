...
class BidRowQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def alerts(
        ...
        Args:
            ...
            retrieve_linked_bid: Whether to retrieve the linked bid
                for each bid row or not.
    ...
    def query(
        ...
        Args:
            retrieve_linked_bid: Whether to retrieve the
                linked bid for each
                bid row or not.
