...
class ShopTimeResolutionAPI(NodeAPI[ShopTimeResolution, ShopTimeResolutionWrite, ShopTimeResolutionList, ShopTimeResolutionWriteList]):
    ...
    def __call__(
    ...
    ) -> ShopTimeResolutionQueryAPI[ShopTimeResolution, ShopTimeResolutionList]:
        ...
        return ShopTimeResolutionQueryAPI(
    ...
    def apply(
        ...
        Args:
            shop_time_resolution: Shop time resolution or
                sequence of shop time resolutions to upsert.
        ...
        Examples:
            ...
            Create a new shop_time_resolution:
                ...
                >>> shop_time_resolution = ShopTimeResolutionWrite(
                ...     external_id="my_shop_time_resolution", ...
                ... )
