...
class PlantWaterValueBasedProductionMaxTimeSeriesQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `plant_water_value_based.production_max_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_production_max_time_series' from 2 weeks ago up until now::

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_max_time_series(external_id="my_production_max_time_series").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `plant_water_value_based.production_max_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_max_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_max_time_series(external_id="my_production_max_time_series").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        column_names: ColumnNames | list[ColumnNames] = "productionMaxTimeSeries",
    ) -> pd.DataFrame:
        """`Retrieve DataFrames for the `plant_water_value_based.production_max_time_series` timeseries.
        ...
        **Performance guide**:
        ...
        Args:
            ...
            column_names: Which property to use for column names. Defauts to productionMaxTimeSeries
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production_max_time_series' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_max_time_series(external_id="my_production_max_time_series").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `plant_water_value_based.production_max_time_series` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_production_max_time_series' for the first month of 2023 in Oslo time:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> from datetime import datetime, timezone
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_based_datapoints = client.plant_water_value_based.production_max_time_series(
                ...     external_id="my_production_max_time_series").retrieve_dataframe_in_timezone(
    ...
    def _retrieve_timeseries_external_ids_with_extra(
        self, extra_properties: ColumnNames | list[ColumnNames] = "productionMaxTimeSeries"
    ) -> dict[str, list[str]]:
        return _retrieve_timeseries_external_ids_with_extra_production_max_time_series(
            self._client,
            self._view_id,
            self._filter,
    ...
    def _rename_columns(
        ...
        if isinstance(column_names, str) and column_names == "productionMaxTimeSeries":
            return df
...
class PlantWaterValueBasedProductionMaxTimeSeriesAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PlantWaterValueBasedProductionMaxTimeSeriesQuery:
        """Query timeseries `plant_water_value_based.production_max_time_series`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the plant_water_value_based.production_max_time_series timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 plant_water_value_based.production_max_time_series timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_baseds = client.plant_water_value_based.production_max_time_series(limit=5).retrieve()
        ...
        return PlantWaterValueBasedProductionMaxTimeSeriesQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `plant_water_value_based.production_max_time_series`
        ...
        Returns:
            List of Timeseries plant_water_value_based.production_max_time_series.

        Examples:

            List plant_water_value_based.production_max_time_series and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> plant_water_value_baseds = client.plant_water_value_based.production_max_time_series.list(limit=5)
        ...
        external_ids = _retrieve_timeseries_external_ids_with_extra_production_max_time_series(self._client, self._view_id, filter_, limit)
        if external_ids:
...
def _retrieve_timeseries_external_ids_with_extra_production_max_time_series(
    client: CogniteClient,
    view_id: dm.ViewId,
    filter_: dm.Filter | None,
    limit: int,
    extra_properties: ColumnNames | list[ColumnNames] = "productionMaxTimeSeries",
) -> dict[str, list[str]]:
    limit_input = float("inf") if limit is None or limit == -1 else limit
    properties = ["productionMaxTimeSeries"]
    if extra_properties == "productionMaxTimeSeries":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "productionMaxTimeSeries":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "productionMaxTimeSeries"])
    else:
    ...
    has_property = dm.filters.Exists(property=view_id.as_property_ref("productionMaxTimeSeries"))
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["productionMaxTimeSeries"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
