    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_activation_price_down'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_activation_price_down' for the
...
class PriceAreaInformationActivationPriceDownAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the price_area_information.activation_price_down timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 price_area_information.activation_price_down timeseries:
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.activation_price_down(
                ...     limit=5
                ... ).retrieve()
