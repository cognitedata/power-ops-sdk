...
class PriceAreaInformationActivationPriceDownQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area_information.activation_price_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_down' from 2 weeks ago up until now::
                ...
                >>> price_area_information_datapoints = client.price_area_information.activation_price_down(external_id="my_activation_price_down").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area_information.activation_price_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_down(external_id="my_activation_price_down").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
            # Missing overload in SDK
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area_information.activation_price_down` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_activation_price_down' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_down(external_id="my_activation_price_down").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area_information.activation_price_down` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_activation_price_down' for the first month of 2023 in Oslo time:
                ...
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_datapoints = client.price_area_information.activation_price_down(
...
class PriceAreaInformationActivationPriceDownAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaInformationActivationPriceDownQuery:
        """Query timeseries `price_area_information.activation_price_down`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area_information.activation_price_down timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area_information.activation_price_down timeseries:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.activation_price_down(limit=5).retrieve()
        ...
        return PriceAreaInformationActivationPriceDownQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area_information.activation_price_down`
        ...
        Returns:
            List of Timeseries price_area_information.activation_price_down.

        Examples:

            List price_area_information.activation_price_down and limit to 5:

                >>> from cognite.powerops.client._generated.v1 import PowerOpsModelsV1Client
                >>> client = PowerOpsModelsV1Client()
                >>> price_area_information_list = client.price_area_information.activation_price_down.list(limit=5)
...
def _retrieve_timeseries_external_ids_with_extra_activation_price_down(
    ...
    for node in builder[0].results:
        ...
        key = view_prop["activationPriceDown"]
