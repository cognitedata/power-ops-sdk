...
MultiScenarioMatrixFields = Literal["resource_cost", "matrix", "asset_type", "asset_id", "is_processed"]
...
class MultiScenarioMatrixWrite(BidMatrixWrite):
    ...
    def _to_instances_write(
        ...
        write_view = (view_by_read_class or {}).get(
            MultiScenarioMatrix, dm.ViewId("sp_powerops_models", "MultiScenarioMatrix", "1")
        )
