...
if TYPE_CHECKING:
    ...
    from ._shop_partial_bid_calculation_input import ShopPartialBidCalculationInput
...
ShopPartialBidCalculationOutputTextFields = Literal["process_id", "function_name"]
ShopPartialBidCalculationOutputFields = Literal["process_id", "process_step", "function_name"]
...
class ShopPartialBidCalculationOutput(DomainModel):
    ...
    bid_matrix_raw: Union[BidMatrixRaw, str, dm.NodeId, None] = Field(None, repr=False, alias="bidMatrixRaw")
