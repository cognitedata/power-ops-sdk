...
class BidMethodDayAheadGraphQL(GraphQLCore):
    """This represents the reading version of bid method day ahead, used
    ...
    view_id = dm.ViewId("sp_powerops_models", "BidMethodDayAhead", "1")
    ...
    def as_read(self) -> BidMethodDayAhead:
        """Convert this GraphQL format of bid method day ahead to the reading format."""
        if self.data_record is None:
            raise ValueError("This object cannot be converted to a read format because it lacks a data record.")
        return BidMethodDayAhead(
            space=self.space,
    ...
    def as_write(self) -> BidMethodDayAheadWrite:
        """Convert this GraphQL format of bid method day ahead to the writing format."""
