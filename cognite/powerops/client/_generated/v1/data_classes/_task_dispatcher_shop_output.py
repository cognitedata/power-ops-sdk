...
if TYPE_CHECKING:
    ...
    from ._task_dispatcher_shop_input import TaskDispatcherShopInput
...
TaskDispatcherShopOutputTextFields = Literal["process_id", "function_name"]
TaskDispatcherShopOutputFields = Literal["process_id", "process_step", "function_name"]
