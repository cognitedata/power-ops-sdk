...
class TaskDispatcherWaterInputGraphQL(GraphQLCore):
    """This represents the reading version of task dispatcher water input, used
    ...
    view_id = dm.ViewId("sp_powerops_models", "TaskDispatcherWaterInput", "1")
    ...
    bid_configuration: Optional[BidConfigurationWaterGraphQL] = Field(None, repr=False, alias="bidConfiguration")
    ...
    def as_read(self) -> TaskDispatcherWaterInput:
        """Convert this GraphQL format of task dispatcher water input to the reading format."""
        if self.data_record is None:
            raise ValueError("This object cannot be converted to a read format because it lacks a data record.")
        return TaskDispatcherWaterInput(
            space=self.space,
    ...
    def as_write(self) -> TaskDispatcherWaterInputWrite:
        """Convert this GraphQL format of task dispatcher water input to the writing format."""
