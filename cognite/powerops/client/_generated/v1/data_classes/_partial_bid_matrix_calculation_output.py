...
if TYPE_CHECKING:
    ...
    from ._partial_bid_matrix_calculation_input import PartialBidMatrixCalculationInput, PartialBidMatrixCalculationInputGraphQL, PartialBidMatrixCalculationInputWrite
...
PartialBidMatrixCalculationOutputFields = Literal["workflow_execution_id", "workflow_step", "function_name", "function_call_id"]
...
class PartialBidMatrixCalculationOutputGraphQL(GraphQLCore):
    ...
    def as_read(self) -> PartialBidMatrixCalculationOutput:
        ...
        return PartialBidMatrixCalculationOutput(
            ...
            partial_matrix=self.partial_matrix.as_read() if isinstance(self.partial_matrix, GraphQLCore) else self.partial_matrix,
    ...
    def as_write(self) -> PartialBidMatrixCalculationOutputWrite:
        ...
        return PartialBidMatrixCalculationOutputWrite(
            ...
            partial_matrix=self.partial_matrix.as_write() if isinstance(self.partial_matrix, GraphQLCore) else self.partial_matrix,
...
class PartialBidMatrixCalculationOutput(FunctionOutput):
    ...
    def as_write(self) -> PartialBidMatrixCalculationOutputWrite:
        ...
        return PartialBidMatrixCalculationOutputWrite(
            ...
            partial_matrix=self.partial_matrix.as_write() if isinstance(self.partial_matrix, DomainModel) else self.partial_matrix,
...
def _create_partial_bid_matrix_calculation_output_filter(
    ...
    if partial_matrix and isinstance(partial_matrix, str):
        filters.append(dm.filters.Equals(view_id.as_property_ref("partialMatrix"), value={"space": DEFAULT_INSTANCE_SPACE, "externalId": partial_matrix}))
    if partial_matrix and isinstance(partial_matrix, tuple):
        filters.append(dm.filters.Equals(view_id.as_property_ref("partialMatrix"), value={"space": partial_matrix[0], "externalId": partial_matrix[1]}))
    if partial_matrix and isinstance(partial_matrix, list) and isinstance(partial_matrix[0], str):
        filters.append(dm.filters.In(view_id.as_property_ref("partialMatrix"), values=[{"space": DEFAULT_INSTANCE_SPACE, "externalId": item} for item in partial_matrix]))
    if partial_matrix and isinstance(partial_matrix, list) and isinstance(partial_matrix[0], tuple):
        filters.append(dm.filters.In(view_id.as_property_ref("partialMatrix"), values=[{"space": item[0], "externalId": item[1]} for item in partial_matrix]))
