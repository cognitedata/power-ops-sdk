...
if TYPE_CHECKING:
    ...
    from ._task_dispatcher_input import TaskDispatcherInput, TaskDispatcherInputWrite
...
class TaskDispatcherOutput(FunctionOutput):
    ...
    process_sub_tasks: Union[list[FunctionInput], list[str], None] = Field(
...
class TaskDispatcherOutputWrite(FunctionOutputWrite):
    ...
    process_sub_tasks: Union[list[FunctionInputWrite], list[str], None] = Field(
        default=None, repr=False, alias="processSubTasks"
    )
