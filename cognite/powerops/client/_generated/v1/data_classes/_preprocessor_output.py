...
class PreprocessorOutputGraphQL(GraphQLCore):
    """This represents the reading version of preprocessor output, used
    ...
    @field_validator("alerts", "case", "input_", mode="before")
    ...
    def as_read(self) -> PreprocessorOutput:
        """Convert this GraphQL format of preprocessor output to the reading format."""
    ...
    def as_write(self) -> PreprocessorOutputWrite:
        """Convert this GraphQL format of preprocessor output to the writing format."""
