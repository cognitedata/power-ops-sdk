...
from cognite.powerops.client._generated.afrr_bids.data_classes._price_area import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new price_area:
                ...
                >>> from cognite.powerops.client._generated.afrr_bids.data_classes import PriceAreaApply
                >>> client = AFRRBidsAPI()
