...
class PriceAreaCapacityPriceDownQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area.capacity_price_down` timeseries.
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area.capacity_price_down` timeseries.
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area.capacity_price_down` timeseries.
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area.capacity_price_down` timeseries in Timezone.
...
class PriceAreaCapacityPriceDownAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaCapacityPriceDownQuery:
        """Query timeseries `price_area.capacity_price_down`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area.capacity_price_down timeseries
        ...
        return PriceAreaCapacityPriceDownQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area.capacity_price_down`
        ...
        Returns:
            List of Timeseries price_area.capacity_price_down.
