...
class BidRowAPI(NodeAPI[BidRow, BidRowApply, BidRowList]):
    ...
    def __call__(
            ...
            [
                QueryStep(
                    ...
                    select=dm.query.Select(
                        [dm.query.SourceSelector(self._view_id, list(_BIDROW_PROPERTIES_BY_FIELD.values()))]
                    ),
                    result_cls=BidRow,
        ...
        return BidRowQueryAPI(self._client, builder, self._view_by_write_class)
    ...
    def apply(self, bid_row: BidRowApply | Sequence[BidRowApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new bid_row:
                ...
                >>> from cognite.powerops.client._generated.afrr_bids.data_classes import BidRowApply
                >>> client = AFRRBidsAPI()
    ...
    def delete(
        self, external_id: str | SequenceNotStr[str], space: str = "power-ops-afrr-bids"
    ...
    @overload
    def retrieve(self, external_id: str) -> BidRow | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str]) -> BidRowList:
        ...
    ...
    def retrieve(
        ...
        return self._retrieve(
            ...
            edge_api_name_type_triple=[
                (self.alerts_edge, "alerts", dm.DirectRelationReference("power-ops-afrr-bids", "BidRow.alerts")),
            ],
        )
