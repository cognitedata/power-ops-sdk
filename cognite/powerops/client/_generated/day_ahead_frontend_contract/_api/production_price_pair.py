...
class ProductionPricePairProductionQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `production_price_pair.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> production_price_pair_datapoints = client.production_price_pair.production(external_id="my_production").retrieve(start="2w-ago)
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `production_price_pair.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pair_datapoints = client.production_price_pair.production(external_id="my_production").retrieve_array(start="2w-ago)
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `production_price_pair.production` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_production' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pair_datapoints = client.production_price_pair.production(external_id="my_production").retrieve_dataframe(start="2w-ago)
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `production_price_pair.production` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_production' for the first month of 2023 in Oslo time:
                ...
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pair_datapoints = client.production_price_pair.production(
...
class ProductionPricePairProductionAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> ProductionPricePairProductionQuery:
        """Query timeseries `production_price_pair.production`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the  production_price_pair.production timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 production_price_pair.production timeseries:

                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pairs = client.production_price_pair.production(limit=5).retrieve()
        ...
        return ProductionPricePairProductionQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `production_price_pair.production`
        ...
        Returns:
            List of Timeseries production_price_pair.production.

        Examples:

            List production_price_pair.production and limit to 5:

                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pairs = client.production_price_pair.production.list(limit=5)
...
class ProductionPricePairAPI(TypeAPI[ProductionPricePair, ProductionPricePairApply, ProductionPricePairList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new production_price_pair:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract.data_classes import ProductionPricePairApply
                >>> client = DayAheadFrontendContractAPI()
        ...
        """
        if isinstance(production_price_pair, ProductionPricePairApply):
            instances = production_price_pair.to_instances_apply(self._view_by_write_class)
        else:
            instances = ProductionPricePairApplyList(production_price_pair).to_instances_apply(
    ...
    @overload
    def retrieve(self, external_id: str) -> ProductionPricePair:
        ...

    @overload
    def retrieve(self, external_id: Sequence[str]) -> ProductionPricePairList:
        ...

    def retrieve(
        self, external_id: str | Sequence[str], space: str = "dayAheadFrontendContractModel"
    ) -> ProductionPricePair | ProductionPricePairList:
    ...
    def search(
        self,
        query: str,
        properties: ProductionPricePairTextFields | Sequence[ProductionPricePairTextFields] | None = None,
        external_id_prefix: str | None = None,
        space: str | list[str] | None = None,
        limit: int = DEFAULT_LIMIT_READ,
        filter: dm.Filter | None = None,
    ) -> ProductionPricePairList:
        """Search production price pairs
        ...
        Returns:
            Search results production price pairs matching the query.

        Examples:

           Search for 'my_production_price_pair' in all text properties:

                >>> from cognite.powerops.client._generated.day_ahead_frontend_contract import DayAheadFrontendContractAPI
                >>> client = DayAheadFrontendContractAPI()
                >>> production_price_pairs = client.production_price_pair.search('my_production_price_pair')
        ...
        return self._search(self._view_id, query, _PRODUCTIONPRICEPAIR_PROPERTIES_BY_FIELD, properties, filter_, limit)
    ...
    def aggregate(
        ...
        group_by: None = None,
        query: str | None = None,
        search_properties: ProductionPricePairTextFields | Sequence[ProductionPricePairTextFields] | None = None,
        external_id_prefix: str | None = None,
        space: str | list[str] | None = None,
        limit: int = DEFAULT_LIMIT_READ,
        filter: dm.Filter | None = None,
    ...
    def aggregate(
        ...
        query: str | None = None,
        search_property: ProductionPricePairTextFields | Sequence[ProductionPricePairTextFields] | None = None,
        external_id_prefix: str | None = None,
        space: str | list[str] | None = None,
        limit: int = DEFAULT_LIMIT_READ,
        filter: dm.Filter | None = None,
