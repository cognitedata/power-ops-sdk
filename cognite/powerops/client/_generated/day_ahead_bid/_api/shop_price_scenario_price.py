...
ColumnNames = Literal["name", "price"]


class SHOPPriceScenarioPriceQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_price_scenario.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> shop_price_scenario_datapoints = client.shop_price_scenario.price(external_id="my_price").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_price_scenario.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_price_scenario_datapoints = client.shop_price_scenario.price(external_id="my_price").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_price_scenario.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_price_scenario_datapoints = client.shop_price_scenario.price(external_id="my_price").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_price_scenario.price` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_price' for the first month of 2023 in Oslo time:
                ...
                >>> client = DayAheadBidAPI()
                >>> shop_price_scenario_datapoints = client.shop_price_scenario.price(
...
class SHOPPriceScenarioPriceAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> SHOPPriceScenarioPriceQuery:
        """Query timeseries `shop_price_scenario.price`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_price_scenario.price timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_price_scenario.price timeseries:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_price_scenarios = client.shop_price_scenario.price(limit=5).retrieve()
        ...
        return SHOPPriceScenarioPriceQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `shop_price_scenario.price`
        ...
        Returns:
            List of Timeseries shop_price_scenario.price.

        Examples:

            List shop_price_scenario.price and limit to 5:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_price_scenarios = client.shop_price_scenario.price.list(limit=5)
