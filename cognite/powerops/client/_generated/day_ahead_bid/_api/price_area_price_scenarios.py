...
class PriceAreaPriceScenariosQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `price_area.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> price_area_datapoints = client.price_area.price_scenarios(external_id="my_price_scenarios").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `price_area.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> price_area_datapoints = client.price_area.price_scenarios(external_id="my_price_scenarios").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `price_area.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> price_area_datapoints = client.price_area.price_scenarios(external_id="my_price_scenarios").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `price_area.price_scenarios` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_price_scenarios' for the first month of 2023 in Oslo time:
                ...
                >>> client = DayAheadBidAPI()
                >>> price_area_datapoints = client.price_area.price_scenarios(
...
class PriceAreaPriceScenariosAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> PriceAreaPriceScenariosQuery:
        """Query timeseries `price_area.price_scenarios`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the price_area.price_scenarios timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 price_area.price_scenarios timeseries:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> price_areas = client.price_area.price_scenarios(limit=5).retrieve()
        ...
        return PriceAreaPriceScenariosQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `price_area.price_scenarios`
        ...
        Returns:
            List of Timeseries price_area.price_scenarios.

        Examples:

            List price_area.price_scenarios and limit to 5:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> price_areas = client.price_area.price_scenarios.list(limit=5)
