...
class SHOPMultiScenarioPriceScenariosQuery:
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `shop_multi_scenario.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> shop_multi_scenario_datapoints = client.shop_multi_scenario.price_scenarios(external_id="my_price_scenarios").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `shop_multi_scenario.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_multi_scenario_datapoints = client.shop_multi_scenario.price_scenarios(external_id="my_price_scenarios").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `shop_multi_scenario.price_scenarios` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price_scenarios' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_multi_scenario_datapoints = client.shop_multi_scenario.price_scenarios(external_id="my_price_scenarios").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `shop_multi_scenario.price_scenarios` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_price_scenarios' for the first month of 2023 in Oslo time:
                ...
                >>> client = DayAheadBidAPI()
                >>> shop_multi_scenario_datapoints = client.shop_multi_scenario.price_scenarios(
...
class SHOPMultiScenarioPriceScenariosAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> SHOPMultiScenarioPriceScenariosQuery:
        """Query timeseries `shop_multi_scenario.price_scenarios`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the shop_multi_scenario.price_scenarios timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 shop_multi_scenario.price_scenarios timeseries:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_multi_scenarios = client.shop_multi_scenario.price_scenarios(limit=5).retrieve()
        ...
        return SHOPMultiScenarioPriceScenariosQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `shop_multi_scenario.price_scenarios`
        ...
        Returns:
            List of Timeseries shop_multi_scenario.price_scenarios.

        Examples:

            List shop_multi_scenario.price_scenarios and limit to 5:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> shop_multi_scenarios = client.shop_multi_scenario.price_scenarios.list(limit=5)
