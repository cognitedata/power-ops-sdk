...
class BidMatrixAlertsAPI(EdgeAPI):
    def list(
        self,
        from_bid_matrix: str | list[str] | dm.NodeId | list[dm.NodeId] | None = None,
        from_bid_matrix_space: str = DEFAULT_INSTANCE_SPACE,
        ...
        """List alert edges of a bid matrix.

        Args:
            from_bid_matrix: ID of the source bid matrix.
            from_bid_matrix_space: Location of the bid matrixes.
        ...
        Examples:
            ...
            List 5 alert edges connected to "my_bid_matrix":
