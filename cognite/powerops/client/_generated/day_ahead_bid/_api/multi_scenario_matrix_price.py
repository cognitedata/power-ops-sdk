...
class MultiScenarioMatrixPriceQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `multi_scenario_matrix.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> multi_scenario_matrix_datapoints = client.multi_scenario_matrix.price(external_id="my_price").retrieve(start="2w-ago")
        """
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `multi_scenario_matrix.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> multi_scenario_matrix_datapoints = client.multi_scenario_matrix.price(external_id="my_price").retrieve_array(start="2w-ago")
        """
        external_ids = self._retrieve_timeseries_external_ids_with_extra()
        if external_ids:
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `multi_scenario_matrix.price` timeseries.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            we are using the time-ago format to get raw data for the 'my_price' from 2 weeks ago up until now::
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> multi_scenario_matrix_datapoints = client.multi_scenario_matrix.price(external_id="my_price").retrieve_dataframe(start="2w-ago")
        """
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `multi_scenario_matrix.price` timeseries in Timezone.
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            get weekly aggregates for the 'my_price' for the first month of 2023 in Oslo time:
                ...
                >>> client = DayAheadBidAPI()
                >>> multi_scenario_matrix_datapoints = client.multi_scenario_matrix.price(
...
class MultiScenarioMatrixPriceAPI:
    ...
    def __call__(
        ...
        filter: dm.Filter | None = None,
    ) -> MultiScenarioMatrixPriceQuery:
        """Query timeseries `multi_scenario_matrix.price`
        ...
        Returns:
            A query object that can be used to retrieve datapoins for the multi_scenario_matrix.price timeseries
            selected in this method.

        Examples:

            Retrieve all data for 5 multi_scenario_matrix.price timeseries:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> multi_scenario_matrixes = client.multi_scenario_matrix.price(limit=5).retrieve()
        ...
        return MultiScenarioMatrixPriceQuery(
            client=self._client,
    ...
    def list(
        ...
        """List timeseries `multi_scenario_matrix.price`
        ...
        Returns:
            List of Timeseries multi_scenario_matrix.price.

        Examples:

            List multi_scenario_matrix.price and limit to 5:

                >>> from cognite.powerops.client._generated.day_ahead_bid import DayAheadBidAPI
                >>> client = DayAheadBidAPI()
                >>> multi_scenario_matrixes = client.multi_scenario_matrix.price.list(limit=5)
