    ...
    def __init__(
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select([dm.query.SourceSelector(self._view_by_write_class[BidMatrixApply], ["*"])]),
        ...
        self._builder.append(
            QueryStep(
                ...
                expression=dm.query.NodeResultSetExpression(
                    ...
                    from_=from_,
                    through=self._view_by_write_class[BidMatrixApply].as_property_ref("method"),
                    direction="outwards",
                ),
