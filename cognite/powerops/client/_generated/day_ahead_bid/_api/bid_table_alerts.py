...
class BidTableAlertsAPI(EdgeAPI):
    def list(
        self,
        from_bid_table: str | list[str] | dm.NodeId | list[dm.NodeId] | None = None,
        from_bid_table_space: str = DEFAULT_INSTANCE_SPACE,
        ...
        Args:
            from_bid_table: ID of the source bid table.
            from_bid_table_space: Location of the bid tables.
