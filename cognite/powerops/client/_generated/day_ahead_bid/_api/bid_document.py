    ...
    def apply(
        ...
        Examples:
            ...
            Create a new bid_document:
                ...
                >>> from cognite.powerops.client._generated.day_ahead_bid.data_classes import BidDocumentApply
    ...
    def retrieve(
        ...
        return self._retrieve(
            ...
            edge_api_name_type_triple=[
                (self.alerts_edge, "alerts", dm.DirectRelationReference("fran-power-ops-shared", "BidDocument.alerts")),
                (
                    self.partials_edge,
                    "partials",
