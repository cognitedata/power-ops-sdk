...
class ShopFilesAPI:
    ...
    def download_to_disk(self, shop_file_id: str, dir_path: Path) -> None:
        ...
        self._po_client.client.files.download_to_path(path=dir_path / shop_file_id, external_id=shop_file_id)
    ...
    def retrieve_related_files_metadata(
        ...
        if not relationships:
            return []
        return self._po_client.client.files.retrieve_multiple(
