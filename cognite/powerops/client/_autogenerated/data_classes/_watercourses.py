...
if TYPE_CHECKING:
    ...
    from cognite.powerops.client.data_classes._watercourse_shops import WatercourseShopApply
...
class WatercourseApply(DomainModelApply):
    ...
    def _to_instances_apply(self, cache: set[str]) -> dm.InstancesApply:
        ...
        if properties:
            source = dm.NodeOrEdgeData(source=dm.ContainerId("power-ops", "Watercourse"), properties=properties)
