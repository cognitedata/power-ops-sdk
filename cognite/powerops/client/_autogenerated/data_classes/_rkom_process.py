...
if TYPE_CHECKING:
    from cognite.powerops.client.data_classes._rkom_bids import RKOMBidApply
...
class RKOMProcesApply(DomainModelApply):
    ...
    def _to_instances_apply(self, cache: set[str]) -> dm.InstancesApply:
        ...
        if properties:
            source = dm.NodeOrEdgeData(source=dm.ContainerId("power-ops", "RKOMProcess"), properties=properties)
