...
from cognite.powerops.resync.v2.utils import check_all_linked_sources_exist, upload_files_to_cdf
...
if __name__ == "__main__":
    local_path = Path(
        "/Users/nina.odegard@cognitedata.com/Documents/GitHub/Cognite/PowerOps/power-ops-sdk/tests/data/demo/v1/resync_configuration.yaml"
    )
    apply(local_path)
