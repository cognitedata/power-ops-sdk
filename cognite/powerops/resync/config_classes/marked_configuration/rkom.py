...
from cognite.powerops.resync.config_classes.marked_configuration import PriceScenarioID
from cognite.powerops.resync.config_classes.marked_configuration._core import Configuration, RelativeTime
