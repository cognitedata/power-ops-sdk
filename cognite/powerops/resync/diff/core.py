...
from cognite.powerops.client._generated.production.data_classes import DomainModelApply as DomainModelApplyProduction
...
def _to_value_by_id(value: Any) -> dict[str, Any]:
    if (
        ...
        and value
        and isinstance(value[0], (DomainModelApplyCogShop1, DomainModelApplyAssets, DomainModelApplyProduction))
    ):
        return {item.external_id: item for item in value}
